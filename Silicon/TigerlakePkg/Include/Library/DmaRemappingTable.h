...
typedef struct {
  EFI_ACPI_DMAR_RMRR_HEADER     RmrrHeader;
  EFI_ACPI_DEV_SCOPE_STRUCTURE  DeviceScope[1];    // TCSS DMA
} EFI_ACPI_RMRR_TCSS_DMA_STRUC;
...
typedef struct {
  ...
  EFI_ACPI_DRHD_ENGINE1_STRUCT  DrhdEngine2;
  EFI_ACPI_DRHD_ENGINE1_STRUCT  DrhdEngineItbt[MAX_ITBT_PCIE_PORT];
  ...
  EFI_ACPI_RMRR_TCSS_DMA_STRUC  RmrrTcssDma0;
  EFI_ACPI_RMRR_TCSS_DMA_STRUC  RmrrTcssDma1;
} EFI_ACPI_DMAR_TABLE;
