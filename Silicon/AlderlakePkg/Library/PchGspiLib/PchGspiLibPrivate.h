...
#define   PCH_GSPI_SITF_SITFL_SHIFT   16
#define   PCH_GSPI_SITF_SITFL_MASK    (0x3F << PCH_GSPI_SITF_SITFL_SHIFT)
#define   PCH_GSPI_SITF_LWMTF_SHIFT   8
#define   PCH_GSPI_SITF_LWMTF_MASK    (0x3F << PCH_GSPI_SITF_LWMTF_SHIFT)
#define   PCH_GSPI_SITF_HWMTF_MASK    0x3F
