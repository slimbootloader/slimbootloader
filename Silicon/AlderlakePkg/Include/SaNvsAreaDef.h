...
typedef struct {
  ...
  UINT8    VmdRp1to8;                               ///< Offset 384     VMD PCH RP 1 to 8 mapped under VMD
  UINT8    VmdRp9to16;                              ///< Offset 385     VMD PCH RP 9 to 16 mapped under VMD
  UINT8    VmdRp17to24;                             ///< Offset 386     VMD PCH RP 17 to 24 mapped under VMD
  UINT8    VmdRp25to32;                             ///< Offset 387     VMD PCH RP 25 to 32 mapped under VMD
  UINT8    VmdSataPort0to7;                         ///< Offset 388     VMD SATA PORT 0 to 7 mapped under VMD
  UINT8    VmdCpuRp;                                ///< Offset 389     VMD CPU RP mapped under VMD
  UINT8    CpuPcieRtd3;                             ///< Offset 390     RTD3 Support for CPU PCIE.
  UINT32   LaneUsed;                                ///< Offset 391     Lane Used of each CSI Port <0:Not Configured, 1:x1, 2:x2, 3:x3 4:x4>
  UINT32   CsiSpeed;                                ///< Offset 395     Speed of each CSI Port <0:Not configured, 1:<416GMbps, 2:<1.5Gbps, 3:<2.0Gbps, 4:<2.5Gbps, 5:<4Gbps, 6:>4Gbps>
  UINT8    MaxPegPortNumber;                        ///< Offset 399     Max PEG port number
  UINT8    MemBootMode;                             ///< Offset 400     Current Memory Boot Mode <0: BOOT_MODE_1LM(Default), 1: BOOT_MODE_2LM, 2: BOOT_MODE_PROVISION>
  UINT8    DpmemSupport;                            ///< Offset 401     Dynamic PMem Support <0: Disabled, 1:Enabled>
  UINT64   PmemStartingAddress;                     ///< Offset 402     Private Pmem Starting address
  UINT64   PmemRangeLength;                         ///< Offset 410     Private Pmem Range Length
  UINT8    IsBridgeDeviceBehindPeg1;                ///< Offset 418     Is bridge device behind Peg1
  UINT8    IsBridgeDeviceBehindPeg2;                ///< Offset 419     Is bridge device behind Peg2
  UINT8    IsBridgeDeviceBehindPeg3;                ///< Offset 420     Is bridge device behind Peg3
  UINT32   CpuPcieRpAddress[4];                     ///< Offset 421     CpuPcieRp Address 1
                                                    ///< Offset 425     CpuPcieRp address 2
