...
//
// MeteorLake CPU Desktop SA Device IDs B0:D0:F0
//
#define V_SA_DEVICE_ID_MB_ULX_1   0x7D00   ///< MeteorLake M (2+8+GT2) SA DID
...
#define V_SA_DEVICE_ID_MB_ULT_4   0x7D06   ///< MeteorLake N (0+4+GT1) SA DID
#define V_SA_DEVICE_ID_MB_ULT_5   0x7D07   ///< MeteorLake P Validation (6+8) SA DID
#define V_SA_DEVICE_ID_MB_ULT_6   0x7D09   ///< ArrowLake P SA DID

#define V_SA_DEVICE_ID_MB_ULT_8   0x7D14   ///< MeteorLake P (4+8) SA DID
#define V_SA_DEVICE_ID_MB_ULT_9   0x7D15   ///< MeteorLake P (4+4) SA DID
#define V_SA_DEVICE_ID_MB_ULT_10  0x7D16   ///< MeteorLake P (2+4) SA DID
#define V_SA_DEVICE_ID_MB_ULT_11  0x7D1E   ///< MeteorLake P (4+0) SA DID

#define V_SA_DEVICE_ID_MB_ULT_12  0x7D21   ///< MeteorLake PS (6+8+GT) SA DID
#define V_SA_DEVICE_ID_MB_ULT_13  0x7D22   ///< MeteorLake PS (4+8+GT) SA DID
#define V_SA_DEVICE_ID_MB_ULT_14  0x7D23   ///< MeteorLake PS (4+4+GT) SA DID
...
#define ARL_SA_DEVICE_ID_HX_8C_16A    0x7D1C   ///< ArrowLake SBG HX (8+16+GT1) SA DID
#define ARL_SA_DEVICE_ID_S_6C_12A     0x7D29   ///< ArrowLake S (6+12) SA DID
#define ARL_SA_DEVICE_ID_S_6C_8A      0x7D2A   ///< ArrowLake S (6+8) SA DID
#define ARL_SA_DEVICE_ID_HX_8C_12A    0x7D2D   ///< ArrowLake SBG HX (8+12+GT1) SA DID
#define ARL_SA_DEVICE_ID_HX_6C_12A    0x7D2E   ///< ArrowLake SBG HX (6+12+GT1) SA DID
...
#define ARL_SA_DEVICE_ID_U_2C_8A      0x7D30   ///< ArrowLake U (2+8) SA DID
#define ARL_SA_DEVICE_ID_H_4C_4A      0x7D31   ///< ArrowLake H (4+4) SA DID
#define ARL_SA_DEVICE_ID_H_6C_4A      0x7D32   ///< ArrowLake H (6+4) SA DID
