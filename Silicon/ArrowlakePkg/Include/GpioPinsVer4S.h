...
/// Unique ID used in GpioPad defines
///
#define GPIO_VER6_SOC_S_CHIPSET_ID     0xA

///
/// MTL SoC-S GPIO Groups
/// Use below for functions from PCH GPIO Lib which
/// require GpioGroup as argument
///
// COM0
#define GPIO_VER6_SOC_S_GROUP_GPP_A           ((GPIO_VER6_SOC_S_CHIPSET_ID << 8) | 0x00)
#define GPIO_VER6_SOC_S_GROUP_VGPIO_0         ((GPIO_VER6_SOC_S_CHIPSET_ID << 8) | 0x01)
#define GPIO_VER6_SOC_S_GROUP_GPP_C           ((GPIO_VER6_SOC_S_CHIPSET_ID << 8) | 0x02)
// COM1
#define GPIO_VER6_SOC_S_GROUP_GPP_B           ((GPIO_VER6_SOC_S_CHIPSET_ID << 8) | 0x03)
#define GPIO_VER6_SOC_S_GROUP_VGPIO_3         ((GPIO_VER6_SOC_S_CHIPSET_ID << 8) | 0x04)
#define GPIO_VER6_SOC_S_GROUP_GPP_D           ((GPIO_VER6_SOC_S_CHIPSET_ID << 8) | 0x05)
// COM2
// COM3
#define GPIO_VER6_SOC_S_GROUP_JTAG            ((GPIO_VER6_SOC_S_CHIPSET_ID << 8) | 0x06)
#define GPIO_VER6_SOC_S_GROUP_VGPIO_4         ((GPIO_VER6_SOC_S_CHIPSET_ID << 8) | 0x07)
