...
#define PCH_SERIAL_IO_BASE_ADDRESS       (PcdGet64(PcdPciExpressBaseAddress) - SIZE_32MB + MTL_PCH_SERIAL_IO_OFFSET)
...
CONST UINT32
mUartMmPciOffset[] = {
  MM_PCI_OFFSET (0x80, PCI_DEVICE_NUMBER_PCH_SERIAL_IO_UART0, PCI_FUNCTION_NUMBER_PCH_SERIAL_IO_UART0),
  MM_PCI_OFFSET (0x80, PCI_DEVICE_NUMBER_PCH_SERIAL_IO_UART1, PCI_FUNCTION_NUMBER_PCH_SERIAL_IO_UART1),
  MM_PCI_OFFSET (0x80, PCI_DEVICE_NUMBER_PCH_SERIAL_IO_UART2, PCI_FUNCTION_NUMBER_PCH_SERIAL_IO_UART2),
  MM_PCI_OFFSET (0x80, PCI_DEVICE_NUMBER_PCH_SERIAL_IO_UART3, PCI_FUNCTION_NUMBER_PCH_SERIAL_IO_UART3),
};
