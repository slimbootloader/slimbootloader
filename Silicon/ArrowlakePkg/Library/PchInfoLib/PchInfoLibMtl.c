...
GLOBAL_REMOVE_IF_UNREFERENCED MTL_INFO_STR_TABLE mMtlSocSkuStrs[] = {
  ...
  {V_MTL_SOC_M_LPC_CFG_DEVICE_ID_MB_14,  "MTL PS SKU"},
  {V_MTL_SOC_M_LPC_CFG_DEVICE_ID_MB_15,  "MTL PS SKU"},
  ...
  {V_MTL_SOC_S_LPC_CFG_DEVICE_ID_MB_16,  "ARL SBGA Super SKU (SSKU)"},
  {V_MTL_SOC_S_LPC_CFG_DEVICE_ID_MB_17,  "ARL SBGA SKU 16"},
  {V_ARL_SOC_M_LPC_CFG_DEVICE_ID_MB_0,   "ARL SoC M Unfused"},
  {V_ARL_SOC_M_LPC_CFG_DEVICE_ID_MB_8,   "ARL PX Super SKU (SSKU)"},
  {V_ARL_SOC_M_LPC_CFG_DEVICE_ID_MB_9,   "ARL PX SKU 9"}
};
  ...
  )
{
  ...
  return FALSE;
#else
  return ((MtlSocGetSeries () == MTL_SOC_M) || (MtlSocGetSeries () == ARL_SOC_M));
#endif
}
...
{
  UINT64  EspiPciCfgBase;

  EspiPciCfgBase = PCI_SEGMENT_LIB_ADDRESS (
                     0x0,
                     0x80,
                     MTL_PCH_ESPI_DEVICE_NUM,
                     MTL_PCH_ESPI_FUNCTION_NUM,
                     0);
  return PciSegmentRead16 (EspiPciCfgBase + PCI_DEVICE_ID_OFFSET);
}
...
{
  switch (MtlPchGetEspiDid () & B_ESPI_CFG_DID) {
    case V_LPC_CFG_DID_MTL_PCH_S:
      return MTL_PCH_S;

    default:
      return MTL_PCH_UNKNOWN_SERIES;
  }
}
...
{
  if (MtlPchGetMaxSerialIoSpiControllersNum () <= SpiNumber) {
    ASSERT (FALSE);
    return 0xFF;
  }
  switch (SpiNumber) {
    case 0:
      return MTL_PCH_SERIALIO_SPI0_DEVICE_NUM;
    case 1:
      return MTL_PCH_SERIALIO_SPI1_DEVICE_NUM;
    case 2:
      return MTL_PCH_SERIALIO_SPI2_DEVICE_NUM;
    case 3:
      return MTL_PCH_SERIALIO_SPI3_DEVICE_NUM;
    default:
      ASSERT (FALSE);
      return 0xFF;
  }
  ...
  )
{
  ...
  switch (SpiNumber) {
    case 0:
      return MTL_PCH_SERIALIO_SPI0_FUNCTION_NUM;
    case 1:
      return MTL_PCH_SERIALIO_SPI1_FUNCTION_NUM;
    case 2:
      return MTL_PCH_SERIALIO_SPI2_FUNCTION_NUM;
    case 3:
      return MTL_PCH_SERIALIO_SPI3_FUNCTION_NUM;
    default:
      ASSERT (FALSE);
      return 0xFF;
  }
...
{
  if (MtlPchGetMaxSerialIoI2cControllersNum () <= I2cNumber) {
    ASSERT (FALSE);
    return 0xFF;
  }
  switch (I2cNumber) {
    case 0:
      return MTL_PCH_SERIALIO_I2C0_DEVICE_NUM;
    case 1:
      return MTL_PCH_SERIALIO_I2C1_DEVICE_NUM;
    case 2:
      return MTL_PCH_SERIALIO_I2C2_DEVICE_NUM;
    case 3:
      return MTL_PCH_SERIALIO_I2C3_DEVICE_NUM;
    case 4:
      return MTL_PCH_SERIALIO_I2C4_DEVICE_NUM;
    case 5:
      return MTL_PCH_SERIALIO_I2C5_DEVICE_NUM;
    default:
      ASSERT (FALSE);
      return 0xFF;
  }
  ...
  )
{
  ...
  switch (I2cNumber) {
    case 0:
      return MTL_PCH_SERIALIO_I2C0_FUNCTION_NUM;
    case 1:
      return MTL_PCH_SERIALIO_I2C1_FUNCTION_NUM;
    case 2:
      return MTL_PCH_SERIALIO_I2C2_FUNCTION_NUM;
    case 3:
      return MTL_PCH_SERIALIO_I2C3_FUNCTION_NUM;
    case 4:
      return MTL_PCH_SERIALIO_I2C4_FUNCTION_NUM;
    case 5:
      return MTL_PCH_SERIALIO_I2C5_FUNCTION_NUM;
    default:
      ASSERT (FALSE);
      return 0xFF;
  }
  ...
  )
{
  ...
  switch (UartNumber) {
    case 0:
      return MTL_PCH_SERIALIO_UART0_DEVICE_NUM;
    case 1:
      return MTL_PCH_SERIALIO_UART1_DEVICE_NUM;
    case 2:
      return MTL_PCH_SERIALIO_UART2_DEVICE_NUM;
    case 3:
      return MTL_PCH_SERIALIO_UART3_DEVICE_NUM;
    default:
      ASSERT (FALSE);
      return 0xFF;
  }
  ...
  )
{
  ...
  switch (UartNumber) {
    case 0:
      return MTL_PCH_SERIALIO_UART0_FUNCTION_NUM;
    case 1:
      return MTL_PCH_SERIALIO_UART1_FUNCTION_NUM;
    case 2:
      return MTL_PCH_SERIALIO_UART2_FUNCTION_NUM;
    case 3:
      return MTL_PCH_SERIALIO_UART3_FUNCTION_NUM;
    default:
      ASSERT (FALSE);
      return 0xFF;
  }
  ...
  )
{
  return PCI_SEGMENT_LIB_ADDRESS (
           MTL_PCH_SEGMENT_NUM,
           MTL_PCH_BUS_NUM,
           MtlPchSerialIoUartDevNumber (UartNumber),
           MtlPchSerialIoUartFuncNumber (UartNumber),
           0
           );
}
