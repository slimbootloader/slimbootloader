...
#include <Register/SaRegsPci000Mtl.h>
...
/**
  Get the total size of NVS OpRegions declared in ACPI.

  @param[in] none

  @retval    UINT32     Size of the GLOBAL_NVS_AREA structure.
...
{
  // return the size of GLOBAL_NVS_AREA structure that contains all NVS OpRegions
