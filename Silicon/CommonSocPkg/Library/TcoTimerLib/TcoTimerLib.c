  ...
  )
{
  ...
  PciWrite32 (PCI_LIB_ADDRESS(0, 31, 4, R_SMBUS_CFG_TCOBASE), TCO_BASE_ADDRESS);

  // Enable TCO base address
  PciWrite32 (PCI_LIB_ADDRESS(0, 31, 4, R_SMBUS_CFG_TCOCTL), B_SMBUS_CFG_TCOCTL_TCO_BASE_EN);
}
