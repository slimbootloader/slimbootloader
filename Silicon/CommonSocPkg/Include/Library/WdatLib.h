...
/**
  ...
  @retval EFI_INVALID_PARAMETER   AcpiHeader is NULL or has zero length.
**/
EFI_STATUS
EFIAPI
...
/**
  ...
  WatchdogHeaderLength is also decremented to preserve byte compatibility
  with legacy WDAT generation in existing platforms.
