...
/** Offset 0x07B8 - Enable PCH PSE ADC pins assigned
...
/** Offset 0x07B9 - Enable PCH PSE CAN pins assigned
...
/** Offset 0x07DD - Enable PCH PSE Timed GPIO 20 pins allocation
  Allocate 20 pins for PCH PSE Timed GPIO. 0: Top 20 pins; 1: Mid 20 pins; 2: Lower 20 pins.
**/
  UINT8                       PchPseTimedGpioPinAllocation[2];

/** Offset 0x07DF - Enable PCH PSE Timed GPIO Pin to PSE TGPIO native function
...
/** Offset 0x081C - Pch Pse Tgpio6 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio6PinMux;

/** Offset 0x0820 - Pch Pse Tgpio7 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio7PinMux;

/** Offset 0x0824 - Pch Pse Tgpio8 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio8PinMux;

/** Offset 0x0828 - Pch Pse Tgpio9 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio9PinMux;

/** Offset 0x082C - Pch Pse Tgpio10 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio10PinMux;

/** Offset 0x0830 - Pch Pse Tgpio11 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio11PinMux;

/** Offset 0x0834 - Pch Pse Tgpio12 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio12PinMux;

/** Offset 0x0838 - Pch Pse Tgpio13 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio13PinMux;

/** Offset 0x083C - Pch Pse Tgpio14 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio14PinMux;

/** Offset 0x0840 - Pch Pse Tgpio15 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio15PinMux;

/** Offset 0x0844 - Pch Pse Tgpio16 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio16PinMux;

/** Offset 0x0848 - Pch Pse Tgpio17 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio17PinMux;

/** Offset 0x084C - Pch Pse Tgpio18 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio18PinMux;

/** Offset 0x0850 - Pch Pse Tgpio19 Pin Mux
  Select PSE Timed Gpio pin muxing. Refer to GPIO_*_MUXING_PSE_TGPIO* for possible values.
**/
  UINT32                      PchPseTgpio19PinMux;

/** Offset 0x0854 - Enable PCH Lan LTR capabilty of PCH internal LAN
  0: Disable; 1: Enable.
  $EN_DIS
**/
  UINT8                       PchLanLtrEnable;

/** Offset 0x0855 - Enable LOCKDOWN BIOS LOCK
...
/** Offset 0x0994 - THC Port 0 Interrupt Pin Mux
...
/** Offset 0x0998 - Touch Host Controller Port 1 Assignment
  Assign THC Port 1
  0x0:ThcAssignmentNone, 0x1:ThcPort1AssignmentThc0, 0x2:ThcAssignmentThc1
**/
  UINT8                       ThcPort1Assignment;

/** Offset 0x0999 - Touch Host Controller Port 1 ReadFrequency
...
/** Offset 0x099A - Touch Host Controller Port 1 WriteFrequency
...
/** Offset 0x0A70 - PCIe EQ phase 1 upstream tranmitter port preset
...
/** Offset 0x0A74 - PCIe EQ phase 2 local transmitter override preset
...
/** Offset 0x0A75 - PCIE Enable Peer Memory Write
...
/** Offset 0x0A77 - PCI Express Clock Gating
...
/** Offset 0x0A78 - PCIE Rp Function Swap
...
/** Offset 0x0A79 - Enable/Disable PEG GEN3 Static EQ Phase1 programming
...
/** Offset 0x0A7A - Enable/Disable GEN4 Static EQ Phase1 programming
...
/** Offset 0x0B38 - Thermal Throttle Lock
  Thermal Throttle Lock.
  $EN_DIS
**/
  UINT8                       PchTTLock;

/** Offset 0x0B39 - Thermal Throttling Suggested Setting
  Thermal Throttling Suggested Setting.
  $EN_DIS
**/
  UINT8                       TTSuggestedSetting;

/** Offset 0x0B3A - Enable PCH Cross Throttling
  Enable/Disable PCH Cross Throttling
  $EN_DIS
**/
  UINT8                       TTCrossThrottling;

/** Offset 0x0B3B - DMI Thermal Sensor Autonomous Width Enable
  DMI Thermal Sensor Autonomous Width Enable.
  $EN_DIS
**/
  UINT8                       PchDmiTsawEn;

/** Offset 0x0B3C - DMI Thermal Sensor Suggested Setting
  DMT thermal sensor suggested representative values.
  $EN_DIS
**/
  UINT8                       DmiSuggestedSetting;

/** Offset 0x0B3D - Thermal Sensor 0 Target Width
  Thermal Sensor 0 Target Width.
  0:x1, 1:x2, 2:x4, 3:x8, 4:x16
**/
  UINT8                       DmiTS0TW;

/** Offset 0x0B3E - Thermal Sensor 1 Target Width
  Thermal Sensor 1 Target Width.
  0:x1, 1:x2, 2:x4, 3:x8, 4:x16
**/
  UINT8                       DmiTS1TW;

/** Offset 0x0B3F - Thermal Sensor 2 Target Width
  Thermal Sensor 2 Target Width.
  0:x1, 1:x2, 2:x4, 3:x8, 4:x16
**/
  UINT8                       DmiTS2TW;

/** Offset 0x0B40 - Thermal Sensor 3 Target Width
  Thermal Sensor 3 Target Width.
  0:x1, 1:x2, 2:x4, 3:x8, 4:x16
**/
  UINT8                       DmiTS3TW;

/** Offset 0x0B41 - Port 0 T1 Multipler
  Port 0 T1 Multipler.
**/
  UINT8                       SataP0T1M;

/** Offset 0x0B42 - Port 0 T2 Multipler
  Port 0 T2 Multipler.
**/
  UINT8                       SataP0T2M;

/** Offset 0x0B43 - Port 0 T3 Multipler
  Port 0 T3 Multipler.
**/
  UINT8                       SataP0T3M;

/** Offset 0x0B44 - Port 0 Tdispatch
  Port 0 Tdispatch.
**/
  UINT8                       SataP0TDisp;

/** Offset 0x0B45 - Port 1 T1 Multipler
  Port 1 T1 Multipler.
**/
  UINT8                       SataP1T1M;

/** Offset 0x0B46 - Port 1 T2 Multipler
  Port 1 T2 Multipler.
**/
  UINT8                       SataP1T2M;

/** Offset 0x0B47 - Port 1 T3 Multipler
  Port 1 T3 Multipler.
**/
  UINT8                       SataP1T3M;

/** Offset 0x0B48 - Port 1 Tdispatch
  Port 1 Tdispatch.
**/
  UINT8                       SataP1TDisp;

/** Offset 0x0B49 - Port 0 Tinactive
  Port 0 Tinactive.
**/
  UINT8                       SataP0Tinact;

/** Offset 0x0B4A - Port 0 Alternate Fast Init Tdispatch
  Port 0 Alternate Fast Init Tdispatch.
  $EN_DIS
**/
  UINT8                       SataP0TDispFinit;

/** Offset 0x0B4B - Port 1 Tinactive
  Port 1 Tinactive.
**/
  UINT8                       SataP1Tinact;

/** Offset 0x0B4C - Port 1 Alternate Fast Init Tdispatch
  Port 1 Alternate Fast Init Tdispatch.
  $EN_DIS
**/
  UINT8                       SataP1TDispFinit;

/** Offset 0x0B4D - Sata Thermal Throttling Suggested Setting
  Sata Thermal Throttling Suggested Setting.
  $EN_DIS
**/
  UINT8                       SataThermalSuggestedSetting;

/** Offset 0x0B4E - Enable Memory Thermal Throttling
  Enable Memory Thermal Throttling.
  $EN_DIS
**/
  UINT8                       PchMemoryThrottlingEnable;

/** Offset 0x0B4F - Memory Thermal Throttling
  Enable Memory Thermal Throttling.
**/
  UINT8                       PchMemoryPmsyncEnable[2];

/** Offset 0x0B51 - Enable Memory Thermal Throttling
  Enable Memory Thermal Throttling.
**/
  UINT8                       PchMemoryC0TransmitEnable[2];

/** Offset 0x0B53 - Enable Memory Thermal Throttling
  Enable Memory Thermal Throttling.
**/
...
/** Offset 0x0B56 - Thermal Device Temperature
  Decides the temperature.
**/
  UINT16                      PchTemperatureHotLevel;

/** Offset 0x0B58 - Enable xHCI Compliance Mode
...
/** Offset 0x0B85 - Enable 8254 Static Clock Gating On S3
...
/** Offset 0x0B86 - PCH Sata Rst Optane Memory
  Optane Memory
  $EN_DIS
**/
  UINT8                       SataRstOptaneMemory;

/** Offset 0x0B87 - PCH Sata Rst CPU Attached Storage
  CPU Attached Storage
  $EN_DIS
**/
  UINT8                       SataRstCpuAttachedStorage;

/** Offset 0x0B88 - Enable TCO timer.
