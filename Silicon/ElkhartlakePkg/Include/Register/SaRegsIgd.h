...
#ifndef CPU_CFL
#ifdef CPU_ICL
#define V_SA_PCI_DEV_2_GT2_ICL_ULX_ID    0x8A60 ///< Dev2 ICL-Y GT2 (4+2)
#define V_SA_PCI_DEV_2_GT2_ICL_ULT_1_ID  0x8A61 ///< Dev2 ICL-U GT2 (4+2)
#define V_SA_PCI_DEV_2_GT3_ICL_ULT_ID    0x8A72 ///< Dev2 ICL-U GT3 (4+3e)
#else
#endif // CPU_ICL
#else
///
...
#define V_SA_CDCLK_CTL_CD2X_PIPE_SELECT_NONE       0x380000
...
#ifdef CPU_ICL
#define B_SA_GTTMMADR_DSSM_REFERENCE_FREQ_MASK   0xE0000000 // Reference Frequency mask
#define B_SA_GTTMMADR_DSSM_REFERENCE_FREQ_OFFSET 0x1D
#endif //CPU_ICL
