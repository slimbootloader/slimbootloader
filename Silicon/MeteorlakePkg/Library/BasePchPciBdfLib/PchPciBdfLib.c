  ...
  )
{
  switch (TsnIndex) {
    case 0:
      return CheckAndReturn (PCI_DEVICE_NUMBER_PCH_TSN0);
    case 1:
  ...
  )
{
  switch (TsnIndex) {
    case 0:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_TSN0);
    case 1:
  ...
  )
{
  switch (RpIndex) {
    ...
    case 13:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_14);
    case 14:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_15);
    case 15:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_16);
    case 16:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_17);
    case 17:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_18);
    case 18:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_19);
    case 19:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_20);
    case 20:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_21);
    case 21:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_22);
    case 22:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_23);
    case 23:
      return CheckAndReturn (PCI_FUNCTION_NUMBER_PCH_PCIE_ROOT_PORT_24);
