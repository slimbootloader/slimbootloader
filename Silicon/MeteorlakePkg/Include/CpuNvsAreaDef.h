...
typedef struct {
  ...
  UINT16   ScalingFactorSmallCore;                  ///< Offset 162     Indicates the Scaling Factor for Small Core
  UINT16   ScalingFactorBigCore;                    ///< Offset 164     Indicates the Scaling Factor for Big Core
  UINT16   NominalFrequency;                        ///< Offset 166     Nominal Frequency
  UINT8    IsNominalFrequencySupported;             ///< Offset 168     Indicates if Nominal Frequency is supported
} CPU_NVS_AREA;
