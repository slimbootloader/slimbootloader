...
//
//  CML PCH-LP SATA Device ID's
//
#define V_CML_PCH_LP_SATA_CFG_DEVICE_ID_M_AHCI         0x02D3  ///< SATA Controller (AHCI) - Mobile
#define V_CML_PCH_LP_SATA_CFG_DEVICE_ID_M_RAID         0x02D5  ///< SATA Controller (RAID 0/1/5/10) - NOT premium - Mobile
#define V_CML_PCH_LP_SATA_CFG_DEVICE_ID_M_RAID_PREM    0x02D7  ///< SATA Controller (RAID 0/1/5/10) - premium - Mobile
#define V_CML_PCH_LP_SATA_CFG_DEVICE_ID_M_RAID_IBC     0x282A  ///< SATA Controller (RAID 0/1/5/10) - In-box compatible - Mobile

//
//  CML PCH-H SATA Device ID's
//
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_D_AHCI         0x06D2  ///< SATA Controller (AHCI) Desktop/Server
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_MH_AHCI        0x06D3  ///< SATA Controller (AHCI) Mobile Halo
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_D_RAID         0x06D4  ///< SATA Controller (RAID 0/1/5/10) - NOT premium Desktop/Server
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_MH_RAID        0x06D5  ///< SATA Controller (RAID 0/1/5/10) - NOT premium Mobile Halo
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_PREM    0x06D6  ///< SATA Controller (RAID 0/1/5/10) - premium Desktop/Server
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_MH_RAID_PREM   0x06D7  ///< SATA Controller (RAID 0/1/5/10) - premium Mobile Halo
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_IBC     0x2822  ///< SATA Controller (RAID 0/1/5/10) - In-box compatible
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_IBC_RST 0x2826  ///< SATA Controller (RAID 0/1/5/10) - In-box compatible (RSTe)
#define V_CML_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_IBC_2   0x282A  ///< SATA Controller (RAID 0/1/5/10) - In-box compatible (Alternate)
...
#define R_SATA_CFG_RST_PCIE_STORAGE_AMXC                0x808                           ///< AHCI MSI-X Configuration
#define B_SATA_CFG_RST_PCIE_STORAGE_AMXC_AMXV           0x7FF                           ///< AHCI MSI-X Vector
...
#define R_SATA_CFG_RST_PCIE_STORAGE_CR1_DMBL            0x884                           ///< CR#1 Device Memory BAR Length
#define R_SATA_CFG_RST_PCIE_STORAGE_CR1_DMXC            0x888                           ///< CR#1 Device MSI-X Configuration
#define N_SATA_CFG_RST_PCIE_STORAGE_CR1_DMXC_MXEV       16
