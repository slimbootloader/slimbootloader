...
#define V_CNL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_E                         0x4
#define V_CNL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_F                         0x5
#define V_CNL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_G                         0x6
#define V_CNL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_H                         0x7
#define V_CNL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_I                         0x8
#define V_CNL_PCH_H_PMC_PWRM_GPIO_CFG_GPD                           0x9
