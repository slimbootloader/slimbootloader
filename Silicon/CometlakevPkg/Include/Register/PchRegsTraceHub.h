...
#define V_CNL_PCH_LP_TRACE_HUB_DEVICE_ID              0x9DA6
#define V_CNL_PCH_H_TRACE_HUB_DEVICE_ID               0xA326
#define V_CML_PCH_LP_TRACE_HUB_DEVICE_ID              0x02A6
#define V_CML_PCH_H_TRACE_HUB_DEVICE_ID               0x06A6
