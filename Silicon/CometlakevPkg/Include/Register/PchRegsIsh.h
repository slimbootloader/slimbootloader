...
#define V_PCH_LP_ISH_CFG_DEVICE_ID            0x9DFC
#define V_PCH_H_ISH_CFG_DEVICE_ID             0xA37C

#define V_CML_PCH_LP_ISH_CFG_DEVICE_ID        0x02FC
#define V_CML_PCH_H_ISH_CFG_DEVICE_ID         0x06FC
