...
#define SERIAL_REGISTER_BASE      0x3E8
  ...
  )
{
  ...
  /* S3M Serial Register Base */
  PcdSet64S (PcdSerialRegBase, (UINT64)(MmioRead32 (BaseAddr + PCI_BASE_ADDRESSREG_OFFSET) & 0xFFFFFFF8));
