...
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_A      0x1
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_R      0x2
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_B      0x3
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_D      0x4
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_C      0x5
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_S      0x6
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_G      0x7
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_VGPIO      0x8
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_E      0x9
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_F      0xA
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_H      0xB
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_J      0xC
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_K      0xD
#define V_TGL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_I      0xE
