  ...
  )
{
  ...
  P2sbBase = MM_PCI_ADDRESS (0, PCI_DEVICE_NUMBER_PCH_P2SB, B_P2SB_CFG_SBISTAT_INITRDY, 0);
  ...
  //
  PchSbiRegister->SbiAddr    = MmioRead32 (P2sbBase + R_P2SB_CFG_SBIADDR);
  PchSbiRegister->SbiExtAddr = MmioRead32 (P2sbBase + R_P2SB_CFG_SBIEXTADDR);
  PchSbiRegister->SbiData    = MmioRead32 (P2sbBase + R_P2SB_CFG_SBIDATA);
  PchSbiRegister->SbiStat    = MmioRead16 (P2sbBase + R_P2SB_CFG_SBISTAT);
  PchSbiRegister->SbiRid     = MmioRead16 (P2sbBase + R_P2SB_CFG_SBIRID);
  ...
  )
{
  ...
  //
  MmioWrite32 (P2sbBase + R_P2SB_CFG_SBIADDR   , PchSbiRegister->SbiAddr);
  MmioWrite32 (P2sbBase + R_P2SB_CFG_SBIEXTADDR, PchSbiRegister->SbiExtAddr);
  MmioWrite32 (P2sbBase + R_P2SB_CFG_SBIDATA   , PchSbiRegister->SbiData);
  MmioWrite16 (P2sbBase + R_P2SB_CFG_SBISTAT   , PchSbiRegister->SbiStat);
  MmioWrite16 (P2sbBase + R_P2SB_CFG_SBIRID    , PchSbiRegister->SbiRid);
