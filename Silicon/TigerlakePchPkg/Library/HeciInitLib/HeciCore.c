  ...
  )
{
  ...
  switch (MeBiosPath) {
    ...
    case DebugModePath:
      ...
      break;
    case RecoveryPath:
      MessageAllowance = (IMR_AND_DID_MSG_ALLOWANCE | HMRFPO_GRP_MSG_ALLOWANCE | MEI_BUS_MSG_ALLOWANCE | DYN_CLIENT_MSG_ALLOWANCE);
      break;
    case SecoverMeiMsgPath:
  ...
  )
{
  ...
  DEBUG ((DEBUG_VERBOSE, "FwVersion through HECI Interfaces TGL \n"));
  //
  ...
  )
{
  ...
  MeFirmwareStatus.ul = HeciPciRead32 (HECI_FUNCTION_NUMBER, R_ME_HFS_6);
