...
/**
  ...
  This function is called on each AP to clear the SMX enable bit.

  @param[in] Arg    Unused argument (required by CPU_TASK_FUNC signature)
...
/**
  ...
  This ensures SMX is disabled on the bootstrap processor before OS boot.
