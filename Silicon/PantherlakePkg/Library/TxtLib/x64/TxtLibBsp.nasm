;; @file
;  This file contains the code to launch BIOS ACM functions in DXE phase
;
...
;    END_FRAME
    ...
    movq    mm3, rax                ; mm3 = address of saved gdtr

    mov     rax, rbp
    movq    mm4, rax                ; mm4 = rbp
    xor     rax, rax
    mov     ax, ss
    movq    mm5, rax                ; mm5 = ss
    mov     ax, cs
...
LaunchBiosAcm_Compatible:
    ...
    movd    mm0, eax                ; Save NXE state in mm0
    xor     edx, edx
    xor     edi, edi
    ...
    ; Reload the GDTR
    ;
    movq    rax, mm3                ; rax = the address of our local variable
    lgdt    [rax]
