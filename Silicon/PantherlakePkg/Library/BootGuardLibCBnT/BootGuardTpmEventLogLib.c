  ...
  )
{
  ...
  if (((SelectedPcrs & HASH_ALG_SHA256) != 0) &&
      (DigestList->count < HASH_COUNT)) {
    CalculateHash((UINT8*)Data, (UINT32)Size, HASH_TYPE_SHA256, (UINT8 *)Sha256);
  ...
  if (((SelectedPcrs & HASH_ALG_SHA384) != 0) &&
      (DigestList->count < HASH_COUNT)) {
    CalculateHash((UINT8*)Data, (UINT32)Size, HASH_TYPE_SHA384, (UINT8 *)Sha384);
  ...
  if (((SelectedPcrs & HASH_ALG_SHA512) != 0) &&
      (DigestList->count < HASH_COUNT)) {
    CalculateHash((UINT8*)Data, (UINT32)Size, HASH_TYPE_SHA512, (UINT8 *)Sha512);
  ...
  if (((SelectedPcrs & HASH_ALG_SM3_256) != 0) &&
      (DigestList->count < HASH_COUNT)) {
    CalculateHash((UINT8*)Data, (UINT32)Size, HASH_TYPE_SM3, (UINT8 *)Sm3);
  ...
  )
{
  ...
  for (Idx = 0; Idx < IbbDigestCount ; Idx++) {
    ...
    switch (CurrDigestAlg) {
      case TPM_ALG_SHA1:
        DEBUG ((DEBUG_INFO, "SHA1 hashing algorithm found in the BPM digests and will not be measured in the TPM event log. SHA1 is not supported in slimboot!!\n"));
        break;
      case TPM_ALG_SHA256:
