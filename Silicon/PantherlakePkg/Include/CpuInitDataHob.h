...
typedef struct {
  ...
  UINT8                  CtdpTar;                  /// CTDP Levels TAR
  UINT8                  ConfigTdpBootModeIndex;                  /// CTDP Boot Mode Index
  UINT16                 CtdpPowerLimit1;          /// CTDP Levels Power Limit1
  UINT16                 CtdpPowerLimit2;          /// CTDP Levels Power Limit2
  UINT8                  CtdpPowerLimitWindow;     /// CTDP Levels Power Limit1 Time Window
