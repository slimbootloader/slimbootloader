...
#define B_ACPI_IO_GPE1_STS_31_0_CNVI_BT_PME_B0_STS    BIT18
#define B_ACPI_IO_GPE1_STS_31_0_TC_IOM_PME_B0_STS     BIT17
#define B_ACPI_IO_GPE1_STS_31_0_TC_TBT1_PME_B0_STS    BIT16
#define B_ACPI_IO_GPE1_STS_31_0_TC_TBT0_PME_B0_STS    BIT15
...
#define B_ACPI_IO_GPE1_STS_63_32_TC_TBT1_HOT_PLUG_STS   BIT13
#define B_ACPI_IO_GPE1_STS_63_32_TC_TBT0_HOT_PLUG_STS   BIT12
#define B_ACPI_IO_GPE1_STS_63_32_TC_PCIE3_HOT_PLUG_STS  BIT11
#define B_ACPI_IO_GPE1_STS_63_32_TC_PCIE2_HOT_PLUG_STS  BIT10
#define B_ACPI_IO_GPE1_STS_63_32_TC_PCIE1_HOT_PLUG_STS  BIT9
#define B_ACPI_IO_GPE1_STS_63_32_TC_PCIE0_HOT_PLUG_STS  BIT8
...
#define B_ACPI_IO_GPE1_STS_95_64_TC_TBT1_PCI_EXP_STS    BIT13
#define B_ACPI_IO_GPE1_STS_95_64_TC_TBT0_PCI_EXP_STS    BIT12
#define B_ACPI_IO_GPE1_STS_95_64_TC_PCIE3_PCI_EXP_STS   BIT11
#define B_ACPI_IO_GPE1_STS_95_64_TC_PCIE2_PCI_EXP_STS   BIT10
#define B_ACPI_IO_GPE1_STS_95_64_TC_PCIE1_PCI_EXP_STS   BIT9
#define B_ACPI_IO_GPE1_STS_95_64_TC_PCIE0_PCI_EXP_STS   BIT8
...
#define V_PMC_PWRM_IPC_CMD_COMMAND_DFX_OVERRIDES            0xA2                        ///< IPC command to control DFx overrides
...
#define V_PMC_PWRM_IPC_CMD_COMMAND_DFX_PWR_STATE            0xA4                        ///< IPC command to control DFX Power State
#define V_PMC_PWRM_IPC_CMD_COMMAND_ID_TCSS_INFO             0xA5                        ///< IPC command for Type-C Information
#define V_PMC_PWRM_IPC_SUBCMD_ID_TCSS_BIOS_INIT_DONE        0x00                        ///< IPC subcommand TCSS init done
#define V_PMC_PWRM_IPC_CMD_COMMAND_CRASHLOG                 0xA6                        ///< CrashLog Command
#define V_PMC_PWRM_IPC_CMD_COMMAND_CONVERT_TO_TYPE_A        0xA7                        ///< IPC command to convert Type-C to type A
...
#define V_PMC_PWRM_IPC_CMD_COMMAND_NAC_STATUS               0xB0                        ///< IPC command to read NAC status
#define V_PMC_PWRM_IPC_CMD_CMD_ID_NAC_MBIST_STATUS             1                        ///< IPC subcommand to read NAC MBIST status
...
#define V_PMC_PWRM_IPC_CMD_READ_QDF                         0xAA                        ///< Command to read QDF
...
#define B_PMC_PWRM_PM_CFG_PWR_CYC_DUR_LEGACY                (BIT9 | BIT8)               ///< Reset Power Cycle Duration
...
#define B_PMC_PWRM_PM_CFG2_PWR_CYC_DUR                      (BIT7 | BIT6 | BIT5 | BIT4 | BIT3 | BIT2 | BIT1 | BIT0)     ///< Reset Power Cycle Duration
#define N_PMC_PWRM_PM_CFG2_PWR_CYC_DUR                      0                           ///< Reset Power Cycle Duration
...
#define B_PMC_PWRM_ADR_EN_C2F_FEAT_EN                       BIT1                        ///< C2F Feature Enable
#define B_PMC_PWRM_ADR_EN_ADR_RESUME_CORE_COUNT_1           BIT2                        ///< Core count during Low power mode
#define B_PMC_PWRM_ADR_EN_ADR_RESUME_CORE_COUNT_2           BIT3                        ///< Core count during Low power mode
#define B_PMC_PWRM_ADR_EN_NAC_IP_PWR_SAVE                   BIT4                        ///< NAC IP Disabled
...
#define R_PMC_PWRM_ADR_GEN_CFG_V0                           0x196C                      ///< ADR General Configuration Register
#define R_PMC_PWRM_ADR_GEN_CFG                              0x1908                      ///< ADR General Configuration
...
#define B_PMC_PWRM_CPPM_MISC_CFG_MAX_CPUMSG_LTR             0xFFFFFF00                  ///< CPPM Miscellaneous Configuration Mask

#define R_PMC_PWRM_CPPM_CG_POL0A                            0x1B24                      ///< CPPM Clock Gating Policy Reg 0A
#define R_PMC_PWRM_CPPM_CG_POL0B                            0x1B28                      ///< CPPM Clock Gating Policy Reg 0B
#define R_PMC_PWRM_CPPM_CG_POL1A                            0x1B2C                      ///< CPPM Clock Gating Policy Reg 1A
#define R_PMC_PWRM_CPPM_CG_POL1B                            0x1B30                      ///< CPPM Clock Gating Policy Reg 1B
#define R_PMC_PWRM_CPPM_CG_POL2A                            0x1B34                      ///< CPPM Clock Gating Policy Reg 2A
#define R_PMC_PWRM_CPPM_CG_POL3A                            0x1B3C                      ///< CPPM Clock Gating Policy Reg 3A
...
#define R_PMC_PWRM_CPPMFALIGNCTL_2                          0x1BCC                      ///< CPPM Forced Alignment Control 2
#define B_PMC_PWRM_CPPMFALIGNCTL_2_MASK                     0x00002EFB                  ///< CPPM MASK
...
#define GPE1_PG5_PMA0_HOT_PLUG_STS_0                    0xBC
#define GPE1_PG5_PMA1_HOT_PLUG_STS_0                    0xB8
#define GPE1_PG5_PMA1_HOT_PLUG_STS_1                    0xB9
...
#define B_ACPI_IO_GPE1_STS_31_0_TBTLSX_PME_B0_STS       BIT1                            ///< TBTLSX_PME_B0_STS
...
#define RTC_UPDATE_TIME_OUT                          0x100000
