...
#define B_GPIO_PCR_MISCCFG_GPVNNREQEN      BIT7
#define B_GPIO_PCR_MISCCFG_GPPGCBDPCGEN    BIT6
...
#define B_GPIO_PCR_PWMC_EN                BIT31
#define B_GPIO_PCR_PWMC_SWUP              BIT30
#define B_GPIO_PCR_PWMC_BASEUNIT          0x3FFFFF00
#define N_GPIO_PCR_PWMC_BASEUNIT          8
#define B_GPIO_PCR_PWMC_ONTIMEDIV         0xFF
...
#define R_GPIO_PCR_GP_SER_DATA            0x0214
...
#define V_GPIO_PCR_RST_CONF_GLOBAL_RST  0x03  // Only for server chipsets
...
#define B_GPIO_PCR_STANDBY_STATE                    (BIT17 | BIT16 | BIT15 | BIT14)
#define N_GPIO_PCR_STANDBY_STATE                    14
#define V_GPIO_PCR_STANDBY_STATE_LATCH_LAST_VALUE   0x00
#define V_GPIO_PCR_STANDBY_STATE_TX0_RX0_RXDIS      0x01
#define V_GPIO_PCR_STANDBY_STATE_TX0_RX1_RXDIS      0x02
#define V_GPIO_PCR_STANDBY_STATE_TX1_RX0_RXDIS      0x03
#define V_GPIO_PCR_STANDBY_STATE_TX1_RX1_RXDIS      0x04
#define V_GPIO_PCR_STANDBY_STATE_TX0_RXEN           0x05
#define V_GPIO_PCR_STANDBY_STATE_TX1_RXEN           0x06
#define V_GPIO_PCR_STANDBY_STATE_HIZ_RX0            0x07
#define V_GPIO_PCR_STANDBY_STATE_HIZ_RX1            0x08
#define V_GPIO_PCR_STANDBY_STATE_TXDIS_RXDIS        0x09
#define V_GPIO_PCR_STANDBY_STATE_MASKED             0x0F

#define B_GPIO_PCR_STANDBY_TERM                    (BIT9 | BIT8)
#define N_GPIO_PCR_STANDBY_TERM                     8
#define V_GPIO_PCR_STANDBY_TERM_SAME_AS_TERM        0x00
#define V_GPIO_PCR_STANDBY_TERM_PUDIS_PDDIS         0x01
#define V_GPIO_PCR_STANDBY_TERM_PUDIS_PDEN          0x02
#define V_GPIO_PCR_STANDBY_TERM_PUEN_PDDIS          0x03
...
#define PCH_GPIO_HDA_SNDW_MULTILINE_NUMBER_OF_DATA_PINS 4
...
// GSX
//
#define B_GPIO_PCH_GPIO_GSX_PCR_C0CAP_DW0_NOUT   (BIT9 | BIT8 | BIT7 | BIT6 | BIT5)
#define B_GPIO_PCH_GPIO_GSX_PCR_C0CAP_DW0_NIN    (BIT4 | BIT3 | BIT2 | BIT1 | BIT0)
#define N_GPIO_PCH_GPIO_GSX_PCR_C0CAP_DW0_NOUT   0x5
#define B_GPIO_PCH_GPIO_GSX_PCR_C0CMD_BUSY       BIT1
#define B_GPIO_PCH_GPIO_GSX_PCR_C0CMD_START      BIT0
