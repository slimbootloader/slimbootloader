...
/**
  ...
  @param[in, out] Data16                  MPHY CR Register Write/Read Data
  @param[in]      WriteSelection          '1' CR Write, '0' CR Read

  @return EFI_SUCCESS                     Successfully execute UIC Command sequence for Attribute Access (B).
  @return others                          Fail to execute UIC Command sequence for Attribute Access (B).
**/
EFI_STATUS
  ...
  )
{
  ...
  UINT32 RefMaxHsGear = (UINT32) (UfsHcVer.Mjr < UFS_HC_VER_3 || UfsDevDescMajorVer < UFS_DEV_VER_3 ? HS_G3 : HS_G4);
