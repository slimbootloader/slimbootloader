...
class Board(BaseBoard):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.ENABLE_CRYPTO_SHA_OPT  = IPP_CRYPTO_OPTIMIZATION_MASK['X64_E9']
    ...
    def GetIppCryptoInf(self):
        ...
        ipp_crypto_inf = os.path.join('BootloaderCommonPkg', 'Library', 'IppCryptoFipsLib', 'IppCryptoFipsLib%s.inf' % ipp_crypto_opt_name[-2:])
