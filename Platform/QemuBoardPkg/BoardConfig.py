...
class Board(BaseBoard):
	...
	def __init__(self, *args, **kwargs):
		...
		if os.path.exists(dirpath + '/BuildData/BuildData.py'):
			print("Found build data generated by Config Editor.")
			with open(dirpath + '/BuildData/BuildData.py', "r") as Fd:
				exec(Fd.read())
		else:
			print("Build data generated by Config editor is not found")
