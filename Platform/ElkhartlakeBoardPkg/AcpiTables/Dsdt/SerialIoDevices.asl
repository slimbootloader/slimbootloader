...
#define SERIAL_IO_SPI0              0x8
#define SERIAL_IO_SPI1              0x9
#define SERIAL_IO_SPI2              0xA
#define SERIAL_IO_UART0             0xB
#define SERIAL_IO_UART1             0xC
#define SERIAL_IO_UART2             0xD
  ...
  Method (UCMM, 1, Serialized) {
    Switch (ToInteger(Arg0)) {
      ...
      Case(SERIAL_IO_I2C2) {
        ...
        I2CSerialBus (0x38, ControllerInitiated, 400000, AddressingMode7Bit, "\\_SB.PC00.I2C2", 0, ResourceConsumer,,)
        I2CSerialBus (0x3F, ControllerInitiated, 400000, AddressingMode7Bit, "\\_SB.PC00.I2C2", 0, ResourceConsumer,,)
        I2CSerialBus (0x20, ControllerInitiated, 400000, AddressingMode7Bit, "\\_SB.PC00.I2C2", 0, ResourceConsumer,,)
        I2CSerialBus (0x27, ControllerInitiated, 400000, AddressingMode7Bit, "\\_SB.PC00.I2C2", 0, ResourceConsumer,,)
        })
        Return (UCM2) }
      Case(SERIAL_IO_I2C3) {
