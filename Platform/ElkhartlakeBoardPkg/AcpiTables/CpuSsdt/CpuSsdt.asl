...
Scope (\_SB.PR00)
{
  ...
  Method (GCAP, 1, Serialized)
  {
    ...
    If (And(\_SB.CFGD, PPM_C_STATES))
    {
      ...
      //
      If (LAnd(LAnd(And(\_SB.CFGD, PPM_CMP),And(PF00,0x0018)),LNot(And(SDTL,0x02))))
      {
        //
    ...
    //
      If (LAnd(And(\_SB.CFGD,PPM_EIST),LNot(And(SDTL,0x08))))
    {
      //
    ...
    //
    If (LAnd(LOr(And(\_SB.CFGD, PPM_EIST), And(\_SB.CFGD, PPM_HWP)), LNot(And(SDTL, 0x100))))
    {
      //
    ...
    If (LGreaterEqual(OSYS, 2015)) {
      If (LAnd(And(\_SB.CFGD, PPM_HWP),LNot(And(SDTL,0x40)))) {
...
Scope(\_SB.PR01)
{
  ...
  {
    If(LAnd(And(\_SB.CFGD,PPM_C_STATES),LNot(And(SDTL,0x20))))
    {
      //
  ...
  {
    If(LAnd(And(\_SB.CFGD,PPM_EIST),LNot(And(SDTL,0x10))))
    {
      //
      // Flag the IST SSDT as loaded for PR00
      //
  ...
  {
    If (LAnd(LOr(And(\_SB.CFGD, PPM_EIST), And(\_SB.CFGD, PPM_HWP)), LNot(And(SDTL, 0x200))))
    {
      //
      // Flag the PSD SSDT as loaded for PR00
      //
  ...
  {
    If ( LGreaterEqual(OSYS, 2015) ) {
      If(LAnd(And(\_SB.CFGD, PPM_HWP),LNot(And(SDTL,0x80)))) {
        //
