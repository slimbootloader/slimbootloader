...
extra_usage_txt = \
"""This script creates a new Elkhartlake Slim Bootloader IFWI image basing
...
Please follow steps below:
  1.  Get an existing Elkhartlake UEFI IFWI image associated with the target platform.
  ...
  2.  Build Slim Bootloader binary, the generated ZIP package is located at:
      $(WORKSPACE)/Outputs/ehl/SlimBootloader.bin
  3.  Stitch to create a new IFWI image.
      EX:
      python StitchLoader.py -i EHL_UEFI_IFWI.bin -s SlimBootloader.bin -o EHL_SBL_IFWI.bin
