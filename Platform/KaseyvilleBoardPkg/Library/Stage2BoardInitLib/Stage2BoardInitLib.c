  ...
  )
{
  ...
  FspsConfig->EnablePcie0 = 1;
  FspsConfig->EnablePcie1 = 1;
  FspsConfig->EnableEmmc  = 1;
  FspsConfig->EnableGbE   = 1;
  FspsConfig->PcieRootPort0DeEmphasis = 0;
  FspsConfig->PcieRootPort1DeEmphasis = 0;
  FspsConfig->PcieRootPort2DeEmphasis = 0;
  FspsConfig->PcieRootPort3DeEmphasis = 0;
  FspsConfig->PcieRootPort4DeEmphasis = 0;
  FspsConfig->PcieRootPort5DeEmphasis = 0;
  FspsConfig->PcieRootPort6DeEmphasis = 0;
  FspsConfig->PcieRootPort7DeEmphasis = 0;

  FspsConfig->PchAdrEn = 2;
  FspsConfig->FspSmmInitEn = 0;

  FspsConfig->PchProtectedRangeLimit[0] = 0xAE0;
  FspsConfig->PchProtectedRangeBase[0]  = 0x12;
  FspsConfig->PchProtectedRangeLimit[1] = 0x1011;
  FspsConfig->PchProtectedRangeBase[1]  = 0xB92;
  FspsConfig->PchProtectedRangeLimit[2] = 0;
  FspsConfig->PchProtectedRangeBase[2]  = 0;
  FspsConfig->PchProtectedRangeLimit[3] = 0;
  FspsConfig->PchProtectedRangeBase[3]  = 0;
  FspsConfig->PchProtectedRangeLimit[4] = 0;
  FspsConfig->PchProtectedRangeBase[4]  = 0;

  FspsConfig->CpuPmC2c3tt                 = 0;
  FspsConfig->CpuPmMonitorMWait           = 1;
  FspsConfig->CpuPmTurboMode              = 1;
  FspsConfig->CpuPmPwrPerfTuning          = 0;
  FspsConfig->CpuPmProcessorHWPMEnable    = 1;
  FspsConfig->CpuPmProcessorHWPMInterrupt = 0;
  FspsConfig->CpuPmProcessorEPPProfile    = 128;
  FspsConfig->CpuPmBootPstate             = 0;
