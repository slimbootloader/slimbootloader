...
#define RTC_ADDRESS_REGISTER_E        14  // RO
  ...
  )
{
  ...
  P2SbAndThenOr32 (PCH_PCR_BASE_ADDRESS, PID_ITSS, 0, R_ITSS_PCR_GIC, (UINT32)~0, B_ITSS_PCR_GIC_AME);
  ...
  P2SbAndThenOr32 (PCH_PCR_BASE_ADDRESS, PID_ITSS, 0, R_ITSS_PCR_GIC, (UINT32)~B_ITSS_PCR_GIC_AME, 0);
