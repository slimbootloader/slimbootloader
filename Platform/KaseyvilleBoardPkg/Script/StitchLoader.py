...
extra_usage_txt = \
"""This script creates a new Kaseyville GNR-D Slim Bootloader IFWI image basing
...
Please follow steps below:
  1.  Get an existing Kaseyville GNR-D UEFI IFWI image associated with the target platform.
  ...
  2.  Build Slim Bootloader binary, the generated ZIP package is located at:
      $(WORKSPACE)/Outputs/gnr/SlimBootloader.bin
  3.  Stitch to create a new IFWI image.
      EX:
      python StitchLoader.py -i GNR_UEFI_IFWI.bin -s SlimBootloader.bin -o GNR_SBL_IFWI.bin
