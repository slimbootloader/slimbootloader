...
Name (THMN, 0x48)  // Master number should align with gSiPkgTokenSpaceGuid.PcdTraceHubDebugLibMaster
...
Name (CNPM, 0x80)  // Channel number per master
Name (FMSN, 0x10)  // Firmware Master start number
