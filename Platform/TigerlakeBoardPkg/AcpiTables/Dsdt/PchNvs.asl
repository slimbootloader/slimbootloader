...
**/
  ...
  Offset(150),    SWMC, 8,  // Offset(150),   HD-Audio SoundWire Master Count
  Offset(151),    XTAL, 8,  // Offset(151),   XTAL frequency: 0: 24MHz; 1: 38.4MHz; 2: Unsupported
  Offset(152),    DSPM, 32, // Offset(152),   HD-Audio DSP Stolen Memory Base Address (@todo: Remove after CNL-LP B0)
  ...
  // PCH Trace Hub
  Offset(664),    PTHM, 8,  // Offset(664),   PCH Trace Hub Mode
  // PCH PS_ON support
  Offset(665),    PSON, 8,  // Offset(665),   PCH PS_ON enable
  //
  // These are for PchApciTablesSelfTest use
  //
  Offset(666),    LTR1, 8,  // Offset(666),   Latency Tolerance Reporting Enable
  Offset(667),    LTR2, 8,  // Offset(667),   Latency Tolerance Reporting Enable
  Offset(668),    LTR3, 8,  // Offset(668),   Latency Tolerance Reporting Enable
  Offset(669),    LTR4, 8,  // Offset(669),   Latency Tolerance Reporting Enable
  Offset(670),    LTR5, 8,  // Offset(670),   Latency Tolerance Reporting Enable
  Offset(671),    LTR6, 8,  // Offset(671),   Latency Tolerance Reporting Enable
  Offset(672),    LTR7, 8,  // Offset(672),   Latency Tolerance Reporting Enable
  Offset(673),    LTR8, 8,  // Offset(673),   Latency Tolerance Reporting Enable
  Offset(674),    LTR9, 8,  // Offset(674),   Latency Tolerance Reporting Enable
  Offset(675),    LTRA, 8,  // Offset(675),   Latency Tolerance Reporting Enable
  Offset(676),    LTRB, 8,  // Offset(676),   Latency Tolerance Reporting Enable
  Offset(677),    LTRC, 8,  // Offset(677),   Latency Tolerance Reporting Enable
  Offset(678),    LTRD, 8,  // Offset(678),   Latency Tolerance Reporting Enable
  Offset(679),    LTRE, 8,  // Offset(679),   Latency Tolerance Reporting Enable
  Offset(680),    LTRF, 8,  // Offset(680),   Latency Tolerance Reporting Enable
  Offset(681),    LTRG, 8,  // Offset(681),   Latency Tolerance Reporting Enable
  Offset(682),    LTRH, 8,  // Offset(682),   Latency Tolerance Reporting Enable
  Offset(683),    LTRI, 8,  // Offset(683),   Latency Tolerance Reporting Enable
  Offset(684),    LTRJ, 8,  // Offset(684),   Latency Tolerance Reporting Enable
  Offset(685),    LTRK, 8,  // Offset(685),   Latency Tolerance Reporting Enable
  Offset(686),    LTRL, 8,  // Offset(686),   Latency Tolerance Reporting Enable
  Offset(687),    LTRM, 8,  // Offset(687),   Latency Tolerance Reporting Enable
  Offset(688),    LTRN, 8,  // Offset(688),   Latency Tolerance Reporting Enable
  Offset(689),    LTRO, 8,  // Offset(689),   Latency Tolerance Reporting Enable
  Offset(690),    GBES, 8,  // Offset(690),   GbE Support
  Offset(691),    PPDS, 32, // Offset(691),   PCH xDCI Power Down Scale Value, DWC_USB3_GCTL_INIT[31:19]
  Offset(695),    EMCE, 8,  // Offset(695),   Set to indicate that eMMC is enabled
  Offset(696),    SDCE, 8,  // Offset(696),   Set to indicate that SD card is enabled
  Offset(697),    TGEA, 8,  // Offset(697),   Set to indicate that Timed GPIO 0 is enabled
  Offset(698),    TGEB, 8,  // Offset(698),   Set to indicate that Timed GPIO 1 is enabled
  Offset(699),    CR00, 8,  // Offset(699),   CLOCK index to root port index map. Used during PCIe D3Cold flows
  Offset(700),    CR01, 8,  // Offset(700),
  Offset(701),    CR02, 8,  // Offset(701),
  Offset(702),    CR03, 8,  // Offset(702),
  Offset(703),    CR04, 8,  // Offset(703),
  Offset(704),    CR05, 8,  // Offset(704),
  Offset(705),    CR06, 8,  // Offset(705),
  Offset(706),    CR07, 8,  // Offset(706),
  Offset(707),    CR08, 8,  // Offset(707),
  Offset(708),    CR09, 8,  // Offset(708),
  Offset(709),    CR10, 8,  // Offset(709),
  Offset(710),    CR11, 8,  // Offset(710),
  Offset(711),    CR12, 8,  // Offset(711),
  Offset(712),    CR13, 8,  // Offset(712),
  Offset(713),    CR14, 8,  // Offset(713),
  Offset(714),    CR15, 8,  // Offset(714),
  Offset(715),    CR16, 8,  // Offset(715),
  Offset(716),    CR17, 8,  // Offset(716),
  Offset(717),    TCOB, 16, // Offset(717),   TCO base address
