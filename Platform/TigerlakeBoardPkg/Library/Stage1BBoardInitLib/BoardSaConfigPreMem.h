...
//
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 mTglULpDdr4RowDisplayDdiConfig[13] = {
                                                                                DdiPortEdp,     // DDI Port A Config : DdiPortADisabled = Disabled, DdiPortAEdp = eDP, DdiPortAMipiDsi = MIPI DSI
