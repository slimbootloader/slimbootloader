...
If (I2SB == 0) {
  ...
  Scope (\_SB.PCH_ROOT_BRIDGE.I2C0) {
    Include ("HdaI2sCodec.asl")
  } // END SCOPE I2C0
}
ElseIf (I2SB == 1) {
  // I2C1 Controller Scope
  Scope (\_SB.PCH_ROOT_BRIDGE.I2C1) {
    Include ("HdaI2sCodec.asl")
  } // END SCOPE I2C1
}
ElseIf (I2SB == 2) {
  // I2C2 Controller Scope
  Scope (\_SB.PCH_ROOT_BRIDGE.I2C2) {
    Include ("HdaI2sCodec.asl")
  } // END SCOPE I2C2
}
ElseIf (I2SB == 3) {
  // I2C3 Controller Scope
  Scope (\_SB.PCH_ROOT_BRIDGE.I2C3) {
    Include ("HdaI2sCodec.asl")
  } // END SCOPE I2C3
}
ElseIf (I2SB == 4) {
  // I2C4 Controller Scope
  Scope (\_SB.PCH_ROOT_BRIDGE.I2C4) {
    Include ("HdaI2sCodec.asl")
  } // END SCOPE I2C4
}
ElseIf (I2SB == 5) {
  // I2C5 Controller Scope
  Scope (\_SB.PCH_ROOT_BRIDGE.I2C5) {
    Include ("HdaI2sCodec.asl")
  } // END SCOPE I2C5
}
...
//
Scope (\_SB.PCH_ROOT_BRIDGE.HDAS)
{
  //
  // Realtek codec
  //
