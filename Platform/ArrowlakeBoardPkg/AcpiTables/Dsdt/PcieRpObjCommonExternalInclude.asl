...
External (\_SB.PC02.RP01.PRMV, IntObj)
External (\_SB.PC02.RP04.PRMV, IntObj)
External (\_SB.PC02.RP05.PRMV, IntObj)
External (\_SB.PC02.RP07.PRMV, IntObj)
External (\_SB.PC02.RP08.PRMV, IntObj)
External (\_SB.PC02.RP09.PRMV, IntObj)
External (\_SB.PC02.RP13.PRMV, IntObj)
External (\_SB.PC02.RP17.PRMV, IntObj)
External (\_SB.PC02.RP21.PRMV, IntObj)

External (\_SB.PC02.RP01.SLOT, IntObj)
External (\_SB.PC02.RP04.SLOT, IntObj)
External (\_SB.PC02.RP05.SLOT, IntObj)
External (\_SB.PC02.RP07.SLOT, IntObj)
External (\_SB.PC02.RP08.SLOT, IntObj)
External (\_SB.PC02.RP09.SLOT, IntObj)
External (\_SB.PC02.RP13.SLOT, IntObj)
External (\_SB.PC02.RP17.SLOT, IntObj)
External (\_SB.PC02.RP21.SLOT, IntObj)

External (\_SB.PC02.RP01.PRTP, IntObj)
External (\_SB.PC02.RP04.PRTP, IntObj)
External (\_SB.PC02.RP05.PRTP, IntObj)
External (\_SB.PC02.RP07.PRTP, IntObj)
External (\_SB.PC02.RP08.PRTP, IntObj)
External (\_SB.PC02.RP09.PRTP, IntObj)
External (\_SB.PC02.RP13.PRTP, IntObj)
External (\_SB.PC02.RP17.PRTP, IntObj)
External (\_SB.PC02.RP21.PRTP, IntObj)

External (\_SB.PC02.RP01.RD3C, IntObj)
External (\_SB.PC02.RP04.RD3C, IntObj)
External (\_SB.PC02.RP05.RD3C, IntObj)
External (\_SB.PC02.RP07.RD3C, IntObj)
External (\_SB.PC02.RP08.RD3C, IntObj)
External (\_SB.PC02.RP09.RD3C, IntObj)
External (\_SB.PC02.RP13.RD3C, IntObj)
External (\_SB.PC02.RP17.RD3C, IntObj)
External (\_SB.PC02.RP21.RD3C, IntObj)
