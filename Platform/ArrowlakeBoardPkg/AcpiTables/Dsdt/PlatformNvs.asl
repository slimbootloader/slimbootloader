...
**/
  ...
  Offset(125),    IT87, 8,  // Offset(125),   SCH3223 SIO Present
  Offset(126),    COM1, 8,  // Offset(126),   SCH3223 COM1
  Offset(127),    COM2, 8,  // Offset(127),   SCH3223 COM2
  Offset(499),              // Offset(128) : Offset(498), Reserved bytes
  ...
  Offset(3294),   CIRM, 8,  // Offset(3294),  CNVi RFI Mitigation
  ...
  Offset(3310),   WDCO, 32, // Offset(3310),  Wlan Device Capabilities Reg Base Address
  ...
  // HD Audio
  Offset(3374),   I2SE, 8,  // Offset(3374),  HD Audio I2S Enable
  // SIO Configuration Registers
  Offset(3375),   ITCM, 8,  // Offset(3375),  IT8659 COM
  Offset(3376),   ITHW, 8,  // Offset(3376),  IT8659 HWMON
  Offset(3377),   ITSI, 8,  // Offset(3377),  IT8659 SIO Present
  Offset(3378),   VTCM, 8,  // Offset(3378),
  //ZPODD support
  Offset(3379),   ZPDA, 32, // Offset(3379),  ZPODD device attention gpio
  Offset(3383),   ZDPR, 32, // Offset(3383),  ZPODD device present gpio
  Offset(3387),   ZDPW, 32, // Offset(3387),  ZPODD device power gpio
  Offset(3391),   ZDPP, 8,  // Offset(3391),  ZPODD device power gpio polarity
  Offset(3392),   ZPPB, 8,  // Offset(3392),  Bitmask of port support zpodd
  Offset(3393),   ARLP, 8,  // Offset(3393),  ARL Mobile Presented
  Offset(3394),   ARLS, 8,  // Offset(3394),  ARL Desktop Presented
  //Foxville RTD3 support
  Offset(3395),   FVWP, 32, // Offset(3395),  Foxville I225 Wake Gpio pin
  Offset(3399),   FVRE, 32, // Offset(3399),  Foxville I225 Reset Gpio pin
  Offset(3403),   FVRP, 8,  // Offset(3403),  Foxville I225 Reset Gpio pin polarity
  Offset(3404),   FVPE, 32, // Offset(3404),  Foxville I225 Disable N Gpio pin
  Offset(3408),   FVPP, 8,  // Offset(3408),  Foxville I225 Disable N Gpio pin polarity
  Offset(3409),   FVSP, 8,  // Offset(3409),  Foxville I225 support configuration
  Offset(3410),   RPFV, 8,  // Offset(3410),  Foxville I225 PCIe Root Port Number
  Offset(3411),   CBTA, 8,  // Offset(3411),  CNVi BT Audio Offload
  Offset(3412),   ICS0, 32, // Offset(3412),  I2C0 Speed Mode Selection
  Offset(3416),   ICS1, 32, // Offset(3416),  I2C1 Speed Mode Selection
  Offset(3420),   ICS2, 32, // Offset(3420),  I2C2 Speed Mode Selection
  Offset(3424),   ICS3, 32, // Offset(3424),  I2C3 Speed Mode Selection
  Offset(3428),   ICS4, 32, // Offset(3428),  I2C4 Speed Mode Selection
  Offset(3432),   ICS5, 32, // Offset(3432),  I2C5 Speed Mode Selection
  Offset(3436),   FNAU, 8,  // Offset(3436),  Enabling Auto Mode for SIO FAN
  Offset(3437),   L0PV, 8,  // Offset(3437),  PPR Value
  Offset(3438),   L0PU, 8,  // Offset(3438),  PPR Unit
  Offset(3439),   L1PV, 8,  // Offset(3439),  PPR Value
  Offset(3440),   L1PU, 8,  // Offset(3440),  PPR Unit
  Offset(3441),   L2PV, 8,  // Offset(3441),  PPR Value
  Offset(3442),   L2PU, 8,  // Offset(3442),  PPR Unit
  Offset(3443),   L3PU, 8,  // Offset(3443),  PPR Unit
  Offset(3444),   L3PV, 8,  // Offset(3444),  PPR Value
  Offset(3445),   L4PU, 8,  // Offset(3445),  PPR Unit
  Offset(3446),   L4PV, 8,  // Offset(3446),  PPR Value
  Offset(3447),   L5PU, 8,  // Offset(3447),  PPR Unit
  Offset(3448),   L5PV, 8,  // Offset(3448),  PPR Value
  //Audio Custom HID Link0
  Offset(3449),   A0H0, 8,  // Offset(3449),  User defined HID ASCII character 0
  Offset(3450),   A0H1, 8,  // Offset(3450),
  Offset(3451),   A0H2, 8,  // Offset(3451),
  Offset(3452),   A0H3, 8,  // Offset(3452),
  Offset(3453),   A0H4, 8,  // Offset(3453),
  Offset(3454),   A0H5, 8,  // Offset(3454),
  Offset(3455),   A0H6, 8,  // Offset(3455),
  Offset(3456),   A0H7, 8,  // Offset(3456),
  Offset(3457),   A0H8, 8,  // Offset(3457),  User defined HID ASCII character 8
  //Audio Custom HID Link1
  Offset(3458),   A1H0, 8,  // Offset(3458),  User defined HID ASCII character 0
  Offset(3459),   A1H1, 8,  // Offset(3459),
  Offset(3460),   A1H2, 8,  // Offset(3460),
  Offset(3461),   A1H3, 8,  // Offset(3461),
  Offset(3462),   A1H4, 8,  // Offset(3462),
  Offset(3463),   A1H5, 8,  // Offset(3463),
  Offset(3464),   A1H6, 8,  // Offset(3464),
  Offset(3465),   A1H7, 8,  // Offset(3465),
  Offset(3466),   A1H8, 8,  // Offset(3466),  User defined HID ASCII character 8
  Offset(3467),   SCS0, 8,  // Offset(3467),  SPI0 ChipSelect 0 Device enabled
  Offset(3468),   SCS1, 8,  // Offset(3468),  SPI0 ChipSelect 1 Device enabled
  Offset(3469),   SCS2, 8,  // Offset(3469),  SPI1 ChipSelect 0 Device enabled
  Offset(3470),   SCS3, 8,  // Offset(3470),  SPI1 ChipSelect 1 Device enabled
  Offset(3471),   SCS4, 8,  // Offset(3471),  SPI2 ChipSelect 0 Device enabled
  Offset(3472),   SCS5, 8,  // Offset(3472),  SPI2 ChipSelect 1 Device enabled
  // CNV GUID lock
  Offset(3473),   CGLS, 8,  // Offset(3473),  CNV Guid Lock Status ACPI Indicator
  Offset(3474),   EVSA, 8,  // Offset(3474),  Everest8326 I2c slave address
  }
