  ...
  )
{
  ...
  switch (BoardId) {
    case BoardIdMtlSUDimm1DEvcrb:
      *PlatformId = PLATFORM_ID_ARL_S_UDIMM_1DPC_RVP;
      break;
    case BoardIdArlhDdr5CRb:
      *PlatformId = PLATFORM_ID_ARL_H_DDR5_CRB;
      break;
  ...
  )
{
  ...
  PciWrite16 (EspiBaseAddr2 + R_LPC_CFG_IOE, Data16);
  ...
  *BoardId = (UINT8) BoardInfo.MtlRvpFields.BoardId;
}
...
)
{
  ...
  *PlatformId = 0xFF;
  ...
  switch (BoardID) {
    ...
    case BoardIdArlhDdr5Rvp:
      *PlatformId = PLATFORM_ID_ARL_H_DDR5_Rvp;
      DEBUG((DEBUG_INFO, "ARLH RVP DETECTED USING EC\n"));
      break;
    default:
