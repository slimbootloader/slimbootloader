  ...
  )
{
  ...
  switch (BoardId) {
   ...
   case  PLATFORM_ID_ARL_H_Island:
    DEBUG((DEBUG_INFO, "BoardIdArlHIsland board Id %x .....\n", BoardId));
    CopyMem(SaDisplayConfigTable, (VOID *)(UINTN)mArlHIslandRowDisplayDdiConfig, sizeof(mArlHIslandRowDisplayDdiConfig));
    break;
  default:
