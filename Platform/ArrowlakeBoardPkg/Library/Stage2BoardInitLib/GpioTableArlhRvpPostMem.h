/** @file
  Arrowlake H RVP GPIO definition table for Post-Memory Initialization
...
**/
#ifndef _ARROW_LAKE_H_DDR5_RVP_POSTMEM_GPIO_TABLE_H_
#define _ARROW_LAKE_H_DDR5_RVP_POSTMEM_GPIO_TABLE_H_

#include <GpioV2PinsMtlSoc.h>
#include <Include/GpioV2Config.h>

GLOBAL_REMOVE_IF_UNREFERENCED GPIOV2_INIT_CONFIG mGpioTablePostMemArlHRvpSbsCrbDimm[] =
{
//
...
//x1 Slot
//
  {GPIOV2_MTL_SOC_M_GPP_B9,{GpioV2PadModeGpio, GpioV2HostOwnAcpi, GpioV2DirOut,  GpioV2StateHigh,   GpioV2IntDis,                    GpioV2ResetHost,      GpioV2TermDefault}},  //X1_PCIE_SLOT3_PWR_EN
