...
CPU_SKU_INFO mCpuSkuInfo[] = {
  ...
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_HALO, ARL_SA_DEVICE_ID_S_4C_8A,    4,  8 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_HALO, ARL_SA_DEVICE_ID_S_2C_8A,    2,  8 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_HALO, ARL_SA_DEVICE_ID_S_2C_4A,    2,  4 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_20A,  ARL_SA_DEVICE_ID_S_4C_4A,    4,  4 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_20A,  ARL_SA_DEVICE_ID_S_6C_4A,    6,  4 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_20A,  ARL_SA_DEVICE_ID_S_6C_8A,    6,  8 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_20A,  ARL_SA_DEVICE_ID_S_4C_8A,    4,  8 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_20A,  ARL_SA_DEVICE_ID_S_2C_8A,    2,  8 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_20A,  ARL_SA_DEVICE_ID_S_2C_4A,    2,  4 },

  //
  // ARL S Refresh
  //
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_HALO, ARL_SA_DEVICE_ID_S_R_8C_16A,  8, 16 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_HALO, ARL_SA_DEVICE_ID_S_R_6C_8A,   6,  8 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_HALO, ARL_SA_DEVICE_ID_S_R_6C_4A,   6,  4 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_HALO, ARL_SA_DEVICE_ID_S_R_8C_12A,  8, 12 },
  { EnumCpuTrad, CPUID_FULL_FAMILY_MODEL_ARROWLAKE_DT_HALO, ARL_SA_DEVICE_ID_S_R_4C_4A,   4, 4  },
