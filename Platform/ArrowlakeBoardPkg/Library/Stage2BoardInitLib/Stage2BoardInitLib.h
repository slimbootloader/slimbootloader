...
#include <MtlPchReservedResources.h>
...
typedef struct {
  ...
  UINT16 SocIoBase;
  UINT16 SocIoLimit;
  UINT32 SocReservedMmioBase;
  UINT32 SocReservedMmioLimit;
  UINT64 SocReservedMmio64Base;
  UINT64 SocReservedMmio64Limit;
  UINT8 PchBusBase;
  UINT8 PchBusLimit;
  UINT16 PchIoBase;
  UINT16 PchIoLimit;
  UINT32 PchReservedMmioBase;
  UINT32 PchReservedMmioLimit;
  UINT64 PchReservedMmio64Base;
  UINT64 PchReservedMmio64Limit;
} IIO_RES_HOB;
