...
def get_xml_change_list (platform, plt_params_list):
    ...
    xml_change_list.append ([
        ...
        ('./FlashLayout/SubPartitions/EsePackage/DmuSubPartition/num_of_instance_DMUBinary_path',   '1'),
        ('./FlashLayout/SubPartitions/EsePackage/DmuSubPartition/DMUBinary',                        '$SourceDir\ESEPlugin#DMUP.bin'),
        ('./FlashLayout/SubPartitions/EsePackage/PunitSubPartition/num_of_instance_PUNITBinary_path', '1'),
