...
extra_usage_txt = \
"""This script creates a new AlderLake Slim Bootloader IFWI image basing
...
Please follow steps below:
  ...
  2.  Build Slim Bootloader binary, the generated ZIP package is located at:
      $(WORKSPACE)/Outputs/adl/SlimBootloader.bin
  3.  Stitch to create a new IFWI image.
      EX:
      python StitchLoader.py -i ADL_UEFI_IFWI.bin -s SlimBootloader.bin -o ADL_SBL_IFWI.bin
