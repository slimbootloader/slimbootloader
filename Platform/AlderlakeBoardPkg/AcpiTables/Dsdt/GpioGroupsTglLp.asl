...
Scope(\_SB)
{
  ...
  Name(GPCL, Package(){
    Package(){ // GPP_B
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_B_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_B_PADCFGLOCKTX,
      0
    },
    Package(){ // GPP_T
      PCH_GPIO_COM0,
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_T_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_T_PADCFGLOCKTX,
      32
    },
    Package(){ // GPP_A
      PCH_GPIO_COM0,
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_A_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_A_PADCFGLOCKTX,
      64
    },
    Package(){ // GPP_R
      PCH_GPIO_COM5,
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_R_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_R_PADCFGLOCKTX,
      352
    },
    Package(){ // SPI
      PCH_GPIO_COM5,
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_SPI_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_SPI_PADCFGLOCKTX,
    ...
    Package(){ // GPD
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPD_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPD_PADCFGLOCKTX,
      GPIO_OS_DRV_NOT_SUPPORTED
    },
    Package(){ // GPP_S
      PCH_GPIO_COM1,
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_S_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_S_PADCFGLOCKTX,
      96
    },
    ...
    **/
    Package(){ // GPP_H
      ...
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_H_PADCFG_OFFSET,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_H_HOSTSW_OWN,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_H_PAD_OWN,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_H_GPI_GPE_STS,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_S_PADCFGLOCK,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_S_PADCFGLOCKTX,
      160
    },
    ...
    Package(){ // GPP_D
      ...
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_D_PADCFG_OFFSET,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_D_HOSTSW_OWN,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_D_PAD_OWN,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_D_GPI_GPE_STS,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_D_PADCFGLOCK,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_D_PADCFGLOCKTX,
      192
    },

    Package(){ // GPP_I
      PCH_GPIO_COM1,
      GPIO_VER2_PCH_N_GPIO_GPP_I_PAD_MAX,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_I_PADCFG_OFFSET,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_I_HOSTSW_OWN,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_I_PAD_OWN,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_I_GPI_GPE_STS,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_I_PADCFGLOCK,
      R_GPIO_VER2_PCH_N_GPIO_PCR_GPP_I_PADCFGLOCKTX,
      128
    },
    ...
    Package(){ // VGPIO
      ...
      R_GPIO_VER2_PCH_N_GPIO_PCR_VGPIO_PADCFG_OFFSET,
      R_GPIO_VER2_PCH_N_GPIO_PCR_VGPIO_HOSTSW_OWN,
      R_GPIO_VER2_PCH_N_GPIO_PCR_VGPIO_PAD_OWN,
      R_GPIO_VER2_PCH_N_GPIO_PCR_VGPIO_GPI_GPE_STS,
      R_GPIO_VER2_PCH_N_GPIO_PCR_VGPIO_PADCFGLOCK,
      R_GPIO_VER2_PCH_N_GPIO_PCR_VGPIO_PADCFGLOCKTX,
      224
    },
#else
    Package(){ // GPP_H
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_H_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_H_PADCFGLOCKTX,
      128
    },
    ...
    Package(){ // GPP_D
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_D_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_D_PADCFGLOCKTX,
      160
    },
    ...
    Package(){ // GPP_U
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_U_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_U_PADCFGLOCKTX,
      192
    },
    ...
    Package(){ // GPP_C
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_C_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_C_PADCFGLOCKTX,
      256
    },
    Package(){ // GPP_F
      PCH_GPIO_COM4,
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_F_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_F_PADCFGLOCKTX,
      288
    },
    Package(){ // HVCMOS
      PCH_GPIO_COM4,
    ...
    Package(){ // GPP_E
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_E_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_GPP_E_PADCFGLOCKTX,
      320
    },
    Package(){ // JTAG
      PCH_GPIO_COM4,
      ...
      NO_REGISTER_FOR_PROPERTY,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_JTAG_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_JTAG_PADCFGLOCKTX,
      GPIO_OS_DRV_NOT_SUPPORTED
    },
    Package(){ // CPU
      PCH_GPIO_COM3,
      ...
      R_GPIO_VER2_PCH_LP_GPIO_PCR_CPU_PADCFGLOCKTX,
      GPIO_OS_DRV_NOT_SUPPORTED
    },
    Package(){ // VGPIO_3
      PCH_GPIO_COM3,
      ...
      NO_REGISTER_FOR_PROPERTY,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_VGPIO_3_PADCFGLOCK,
      R_GPIO_VER2_PCH_LP_GPIO_PCR_VGPIO_3_PADCFGLOCKTX,
      GPIO_OS_DRV_NOT_SUPPORTED
    }
  })
