/** @file
  AlderLake PTEST RVP GPIO definition table for Post-Memory Initialization

  Copyright (c) 2021, Intel Corporation. All rights reserved.<BR>
  SPDX-License-Identifier: BSD-2-Clause-Patent

**/
#ifndef _ALDER_LAKE_PTEST_DDR5_CRB_POSTMEM_GPIO_TABLE_H_
#define _ALDER_LAKE_PTEST_DDR5_CRB_POSTMEM_GPIO_TABLE_H_

#include <GpioPinsVer2Lp.h>
#include <GpioConfig.h>

GLOBAL_REMOVE_IF_UNREFERENCED GPIO_INIT_CONFIG mGpioTablePostMemAdlPtestDdr5Rvp[] =
{
  //CPU M.2 SSD1
...
#endif // _ALDER_LAKE_PTEST_DDR5_CRB_POSTMEM_GPIO_TABLE_H_
