...
class Board(BaseBoard):
    def __init__(self, *args, **kwargs):
        ...
        #   VbtBin folder.
        self._MULTI_VBT_FILE      = {1:'VbtAdlnUpProTwl.dat'} # self._MULTI_VBT_FILE      = {1:'VbtAdlNCrb.dat', 2:'VbtAdlNCrbEdp.dat', 3:'VbtAdlNUp2ProTwl.dat'}
        ...
        self._CFGDATA_EXT_FILE = [self._generated_cfg_file_prefix + 'CfgDataExt_Up2ProTwl.dlt']
