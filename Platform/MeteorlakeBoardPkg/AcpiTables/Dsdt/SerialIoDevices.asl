  ...
  Method (I2CM, 3, Serialized) {
    Switch (ToInteger(Arg0)) {
      ...
      Case (SERIAL_IO_I2C5) { Name (IIC5 , ResourceTemplate () {I2cSerialBusV2 (0, ControllerInitiated, 400000, AddressingMode7Bit,"\\_SB.PC00.I2C5", 0x00, ResourceConsumer, DEV5, , ) })
        ...
        Store (Arg2, DSP5)
        Return (IIC5) }
      Case(SERIAL_IO_I2C6) { Name (IIC6 , ResourceTemplate () { I2cSerialBusV2 (0, ControllerInitiated, 400000, AddressingMode7Bit,"\\_SB.PC00.I2C6", 0x00, ResourceConsumer, DEV6,) })
        CreateWordField (IIC6, DEV6._ADR, DAD6)
        CreateDWordField(IIC6,DEV6._SPE,DSP6)
        Store (Arg1, DAD6)
        Store (Arg2, DSP6)
        Return (IIC6) }
      Case(SERIAL_IO_I2C7) { Name (IIC7 , ResourceTemplate () { I2cSerialBusV2 (0, ControllerInitiated, 400000, AddressingMode7Bit,"\\_SB.PC00.I2C7", 0x00, ResourceConsumer, DEV7,) })
