...
#define B_ICLK_PCR_FREQUENCY                            (Or(BIT0, BIT1))
#define B_ICLK_PCR_REQUEST                              BIT2

#define PID_ICLK                                0x64
  ...
  Device (ICLK) {
    ...
    Method (CLKC, 0x2, NotSerialized)
    {
      ...
      Switch(ToInteger(Arg0)) {
        Case (0) {
          Store(CLK0, Local0)
          Store(Or(And(Local0, Not(B_ICLK_PCR_REQUEST)), ShiftLeft(Arg1, 2)), CLK0)
        }
        Case (1) {
          Store(CLK1, Local0)
          Store(Or(And(Local0, Not(B_ICLK_PCR_REQUEST)), ShiftLeft(Arg1, 2)), CLK1)
        }
        Case (2) {
          Store(CLK2, Local0)
          Store(Or(And(Local0, Not(B_ICLK_PCR_REQUEST)), ShiftLeft(Arg1, 2)), CLK2)
        }
        Case (3) {
          Store(CLK3, Local0)
          Store(Or(And(Local0, Not(B_ICLK_PCR_REQUEST)), ShiftLeft(Arg1, 2)), CLK3)
        }
        Case (4) {
          Store(CLK4, Local0)
          Store(Or(And(Local0, Not(B_ICLK_PCR_REQUEST)), ShiftLeft(Arg1, 2)), CLK4)
        }
        Case (5) {
          Store(CLK5, Local0)
          Store(Or(And(Local0, Not(B_ICLK_PCR_REQUEST)), ShiftLeft(Arg1, 2)), CLK5)
        }
      }
    }
    ...
    Method (CLKF, 0x2, NotSerialized)
    {
      ...
      If(LAnd (LLess(Arg0, NCLK()), LEqual(PCHS, PCHP)))
      {
        Switch(ToInteger(Arg0)) {
          Case (0) {
            Store(CLK0, Local0)
            Store(Or(And(Local0, Not(B_ICLK_PCR_FREQUENCY)), And(Arg1, B_ICLK_PCR_FREQUENCY)), CLK0)
          }
          Case (1) {
            Store(CLK1, Local0)
            Store(Or(And(Local0, Not(B_ICLK_PCR_FREQUENCY)), And(Arg1, B_ICLK_PCR_FREQUENCY)), CLK1)
          }
          Case (2) {
            Store(CLK2, Local0)
            Store(Or(And(Local0, Not(B_ICLK_PCR_FREQUENCY)), And(Arg1, B_ICLK_PCR_FREQUENCY)), CLK2)
          }
          Case (3) {
            Store(CLK3, Local0)
            Store(Or(And(Local0, Not(B_ICLK_PCR_FREQUENCY)), And(Arg1, B_ICLK_PCR_FREQUENCY)), CLK3)
          }
          Case (4) {
            Store(CLK4, Local0)
            Store(Or(And(Local0, Not(B_ICLK_PCR_FREQUENCY)), And(Arg1, B_ICLK_PCR_FREQUENCY)), CLK4)
          }
          Case (5) {
            Store(CLK5, Local0)
            Store(Or(And(Local0, Not(B_ICLK_PCR_FREQUENCY)), And(Arg1, B_ICLK_PCR_FREQUENCY)), CLK5)
          }
        }
      }
    }
