  ...
  )
{
  ...
  switch (BoardId) {
    case BoardIdMtlPDdr5SODimmSbsRvp:
      *PlatformId = PLATFORM_ID_MTL_P_DDR5_RVP;
      break;
    case BoardIdMtlPSDdr5Rvp:
      *PlatformId = PLATFORM_ID_MTL_PS_DDR5_RVP;
      break;
    case BoardIdMtlPSDdr5Crb:
      *PlatformId = PLATFORM_ID_MTL_PS_DDR5_CRB;
      break;
  ...
  *PlatformId = 0xFF;
  ...
  switch (BoardID) {
    ...
    case BoardIdMtlPLp5xT3Rvp:
      *PlatformId = PLATFORM_ID_MTL_P_LPDDR5_T3_RVP;
      break;
    case BoardIdMtlPSDdr5Rvp:
      *PlatformId = PLATFORM_ID_MTL_PS_DDR5_RVP;
      break;
