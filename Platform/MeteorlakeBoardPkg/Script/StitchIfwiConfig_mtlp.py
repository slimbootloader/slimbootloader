...
def get_xml_change_list (platform, plt_params_list):
    ...
    if 'lp5' in plt_params_list:
        print ("Applying changes to enable LPDDR5")
        xml_change_list.append ([
            ('./FlashLayout/DescriptorRegion/HarnessGlobalData/SelectedRvp',                  'MTL-P LP5x T3 (MTL-P + MTP-P)'),
            ('./FlashLayout/DescriptorRegion/HarnessGlobalData/HarnessProject',               'MTP-P A0 SoC v5 (MTL-P CPU) RDL v1.0.0.15 SMIP Change'),
            ('./FlashLayout/DescriptorRegion/HarnessGlobalData/HarnessLabel',                 'v1.0 MTP-P A0 SoC (MTL-P CPU) (Harness #20)'),
            ('./FlashLayout/DescriptorRegion/HarnessGlobalData/HarnessRevision',              '20'),
            ('./FlashSettings/BiosConfiguration/TopSwapOverride',                             '4MB'),
            ('./PlatformProtection/IntelPttConfiguration/PttSupported',                       'Yes'),
            ('./PlatformProtection/IntelPttConfiguration/PttPwrUpState',                      'Enabled'),
            ('./PlatformProtection/IntelPttConfiguration/PttSupportedFpf',                    'Yes'),
