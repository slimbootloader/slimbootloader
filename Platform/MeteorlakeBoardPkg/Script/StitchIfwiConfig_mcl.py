...
def get_xml_change_list (platform, plt_params_list):
    ...
    xml_change_list.append ([
      ...
      #Region Order
        ...
        ('./FlexIO/TypeCPortConfiguration/TypeCPorts3and4SpdselPair',                'Type C Port 3 and 4 Gen 2x2'),
        ...
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort1SmbusAddr',          '0x23'),
        ...
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort2SMBusAddr',          '0x27'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/USB2PortForTypeCPort2',        'USB2 Port 2'),
