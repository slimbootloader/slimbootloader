...
#define I2C_POSTCODE_PORT_NUMBER              0x00
  ...
  )
{
  ...
  // I2C Post Code - resolve PciCfgBase from I2C controller number
  ...
  //
  // Set config register format command 0x04 to indicate normal operation, slow
