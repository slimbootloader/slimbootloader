...
Scope (\_SB.PC00) {
  ...
  Device (RP01) {
    ...
    Name (RD3C, 2) // 2: D3Cold support for Storage connected to PCIE port, 1: D3Hot support for Storage connected to PCIE port,
                 // 0: D3 unsupport for Storage connected to PCIE port. By default this is set as 2 for other EndPoints
    Method (_INI)
    {
      Store (LTR1, LTEN)
      Store (PML1, LMSL)
      ...
      If (LAnd (CondRefOf (VMPP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMPP, 0x1), 0))) {
          ADBG ("RP01 (B0/D28/F0) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
    ...
    #define PCIE_HP_EN GPE1_PCI_EXP_SPA
  ...
  Device (RP02) {
    ...
    Method (_INI)
    {
      ...
      Store (PNL2, LNSL)
      If (LAnd (CondRefOf (VMPP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMPP, 0x2), 0))) {
          ADBG ("RP02 (B0/D28/F1) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
  ...
  Device (RP03) {
    ...
    Method (_INI)
    {
      ...
      Store (PNL3, LNSL)
      If (LAnd (CondRefOf (VMPP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMPP, 0x4), 0))) {
          ADBG ("RP03 (B0/D28/F2) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
  ...
  Device (RP04) {
    ...
    Method (_INI)
    {
      ...
      Store (PNL4, LNSL)
      If (LAnd (CondRefOf (VMPP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMPP, 0x8), 0))) {
          ADBG ("RP04 (B0/D28/F3)is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
  ...
  Device (RP05) {
    ...
    Method (_INI)
    {
      ...
      If (LAnd (CondRefOf (VMPP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMPP, 0x10), 0))) {
          ADBG ("RP05 (B0/D28/F4) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
    ...
    #define PCIE_HP_EN GPE1_PCI_EXP_SPC
#else
    #define PCIE_HP_EN GPE1_PCI_EXP_SPB
#endif
    Include ("PcieCommon.asl")
    #undef PCIE_HP_EN
    ...
    Method (_INI)
    {
      ...
      If (LAnd (CondRefOf (VMPP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMPP, 0x20), 0))) {
          ADBG ("RP06 (B0/D28/F5) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
    ...
    Method (_INI)
    {
      ...
      If (LAnd (CondRefOf (VMPP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMPP, 0x40), 0))) {
          ADBG ("RP07 (B0/D28/F6) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
    ...
    Method (_INI)
    {
      ...
      If (LAnd (CondRefOf (VMPP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMPP, 0x80), 0))) {
          ADBG ("RP08 (B0/D28/F7) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
  ...
  Device (RP09) {
    ...
    Method (_INI)
    {
      ...
      If (LAnd (CondRefOf (VMSP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMSP, 0x01), 0))) {
          ADBG ("RP09 (B0/D6/F0) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
    ...
    #define PCIE_HP_EN GPE1_PG5_PMA0_PCI_EXP_EN_0
    Include ("PcieCommon.asl")
    #undef PCIE_HP_EN
    ...
    Method (_INI)
    {
      ...
      If (LAnd (CondRefOf (VMSP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMSP, 0x02), 0))) {
          ADBG ("RP10 (B0/D6/F1) is mapped under VMD")
          Store (1, PRMV)
        }
      }
   If (PRES ()) {
  ...
  If (LEqual (PCHS, PCHH)) {
    ...
    Device (RP11) {
      ...
      Method (_INI)
      {
        ...
        Store (PNLB, LNSL)
        If (LAnd (CondRefOf (VMSP),CondRefOf (VMDE))) {
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMSP, 0x04), 0))) {
          ADBG ("RP11 (B0/D6/F2) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
    ...
    #undef PCIE_ROOT_PORT
      ...
      #define PCIE_HP_EN GPE1_PG5_PMA1_PCI_EXP_EN_0
      Include ("PcieCommon.asl")
      #undef PCIE_HP_EN
    ...
    Device (RP12) {
      ...
      Method (_INI)
      {
        ...
        If (LAnd (LEqual (VMDE, 1), LNotEqual (And (VMSP, 0x08), 0))) {
          ADBG ("RP12 (B0/D6/F3) is mapped under VMD")
          Store (1, PRMV)
        }
      }
      If (PRES ()) {
    ...
    #undef PCIE_ROOT_PORT
      ...
      #define PCIE_HP_EN GPE1_PG5_PMA1_PCI_EXP_EN_1
      Include ("PcieCommon.asl")
      #undef PCIE_HP_EN
    }                                                // end "PCIE Root Port#10"
  }
