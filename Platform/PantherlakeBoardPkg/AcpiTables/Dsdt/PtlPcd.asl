 ...
 //
  ...
  Device (PRRE) {
    ...
    Method (_CRS,0,Serialized)
    {
      ...
      //
      // PTL_PCD_GPIOV2_COM0 = 0x59
      // PTL_PCD_GPIOV2_COM1 = 0x5A
      // PTL_PCD_GPIOV2_COM3 = 0x5B
      // PTL_PCD_GPIOV2_COM4 = 0x5C
      // PTL_PCD_GPIOV2_COM5 = 0x5D
      //
      ...
      Name (SBR0, ResourceTemplate () {
        ...
        Store (SBRG, BAS0)
        Store (PTL_PCD_GPIOV2_COM0, LEN0)
      ...
      Store (Add (Add (SBRG, PTL_PCD_GPIOV2_COM5), PCR_MMIO_SIZE_PER_PID), BAS1)
