...
Name (THMN, 0x48)  // Host number should align with gSiPkgTokenSpaceGuid.PcdTraceHubDebugLibHost
...
Scope (\) {
  ...
  Method (THDA, 2, Serialized) {
    // Local0 = TFWB + 0x40 * (V_TRACE_HUB_MEM_STHCAP1_CHLCNT * (Host - V_TRACE_HUB_MEM_STHCAP1_FW_MSTR)) + 0x40 * Channel;
    Store (TFWB, Local0)
