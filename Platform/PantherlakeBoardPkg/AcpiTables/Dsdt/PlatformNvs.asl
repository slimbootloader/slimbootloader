...
**/
  ...
  TCGP, 8,  // Offset(39),    Used for save the Mor and/or physical presence parameter
  ...
  DPTC, 8,  // Offset(2353),  Depth Camera Address
  CEDS, 8,  // Offset(2354),  Convertible Dock Support
