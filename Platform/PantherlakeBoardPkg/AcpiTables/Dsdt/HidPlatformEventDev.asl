...
**/
#if (FixedPcdGetBool (PcdWclSupport) == 1)          // HID value depending on Platform
  #define HIDD_HID "INTC10F1"
#else
  #define HIDD_HID "INTC10CC"
#endif
...
Scope (\_SB)
{
  ...
  {
    Name (_HID, HIDD_HID)                            // Intel Ultrabook HID Platform Event Driver.
