...
// note that the Intel CRBs have the ability to output a Word to
...
// Global mask to track PG3 consent from IPs.
// Bit:  0 - CNVi
Name(GP3M, 0x0) // default value -by default enable

//
// Global PG3 veto tracker. Gathers information from all IPs about PG3
// consent.
// Arg0 - Interface index, 0 - CNVi
// Arg1 - 0: Allow PG3, 1: veto PG3
//
...
//
  ...
  Field (CPWR, ByteAcc, NoLock, Preserve)
  {
    ...
    Offset (0xE90), // Isys Control register
    ISCL, 64,
  }
  ...
  Method (_OSC,4,Serialized)
  {
    ...
    If (LEqual (Arg0,ToUUID ("0811B06E-4A27-44F9-8D60-3CBBC22E7B48")))
    {
      ...
      If (LEqual (OSCM, 1))
      {
        ...
        // OSPM USB supported field (bit 5:0) valid value : 0 - USB4 Ver1, 1 - USB4 Ver2.
        // Observe 0xFF is also reported by Windows HRD driver that doesn't support USB4 Ver2.
        //
        ...
        If (LEqual (Arg1, One))
        {
          ...
          //
          // Save OSPM USB support field (bit 5:0) if the value is valid
          // 0 - USB4 Ver1, 1 - USB4 Ver2
          //
