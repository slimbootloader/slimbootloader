/** @file
  This file contains the TCSS DMA ASL code. It defines a Power Management for TCSS DMA
...
**/
  ...
  Field (DPME,AnyAcc,NoLock,Preserve)
  {
    Offset (0),
    VDID, 32,
    Offset (R_USB4_CFG_TBT_DMA_CFG_PM_CAP_1),    // 0x84
    PMST, 2,       // 1:0, PM_STATE
    , 6,
    PMEE, 1,       // 8, PME_EN
    , 6,
    PMES, 1,       // 15, PME_STATUS
    Offset (R_USB4_CFG_TBT_DMA_CFG_VS_CAP_22), // 0xFC
