...
**/
  ...
  Method (_PRW, 0) {
    ...
    // The actual S4 wake capability will be limited by VCST setting instead of OS management. Platform shall set VCCST setting to OFF when not supporting S4 wake over USBC.
    //
