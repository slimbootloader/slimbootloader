  ...
  Method (IMNG, 1)
  {
    Switch (ToInteger (Arg0)) {
      Case (3) {
        ...
        If (LEqual (INDP, 1)) {
          Store (1, IGFG) // Set Internal Monitor off flag for skipping notification to iGfx after PEP Fun#3 Display off notification.
        }
        If (LEqual (DPHD, 1)) {
  ...
  If (TRTD) {
    Method (TCON, 0) {
      ...
      //Reset IOM D3 cold bit
        ...
        //
        // Drop this method due to it is already exit D3 cold
        //
