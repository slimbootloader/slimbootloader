...
B1ST, 8,      // 50         Battery 1 Status
              // 50.0       Battery is discharging
              // 50.1       Battery is charging
              // 50.2       Battery is in critical energy state
              // 50.3       Battery is present
              // 50.4       Virtual AC power is present
B1CR, 8,      // 51         Battery 1 current rate
B1CS, 8,      // 52         Battery 1 remaining percentage
...
FRTS, 8,      // 75         FRTS- Fan RPM trip status register:
              ...
              //              BIT1:  TFN2
              //              BIT2:  TFN3
FSHS, 16,     // 76,77      Fan speed threshold Hysterisis
Offset(78),
