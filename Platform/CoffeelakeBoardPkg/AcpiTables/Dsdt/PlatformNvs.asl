...
**/
  ...
  // DPPM Policies
  //
  Offset(147),    DPAP, 8,  // Offset(147),   EnableActivePolicy
  Offset(148),    DPPP, 8,  // Offset(148),   EnablePassivePolicy
  Offset(149),    DPCP, 8,  // Offset(149),   EnableCriticalPolicy
  Offset(150),    PIDE, 8,  // Offset(150),   EnablePIDPolicy
  Offset(151),    TRTV, 8,  // Offset(151),   TrtRevision
  //
  // CLPO (Current Logical Processor Off lining Setting)
  //
  Offset(152),    LPOE, 8,  // Offset(152),   LPOEnable
  Offset(153),    LPOP, 8,  // Offset(153),   LPOStartPState
  Offset(154),    LPOS, 8,  // Offset(154),   LPOStepSize
  Offset(155),    LPOW, 8,  // Offset(155),   LPOPowerControlSetting
  Offset(156),    LPER, 8,  // Offset(156),   LPOPerformanceControlSetting
  //
  // Miscellaneous DPTF
  //
  Offset(157),    PPSZ, 32, // Offset(157),   PPCC Step Size
  Offset(161),    DISE, 8,  // Offset(161),   EnableDisplayParticipant
  //
  // BIOS Guard
  //
  Offset(162),    BGMA, 64, // Offset(162),   BIOS Guard Memory Address for Tool Interface
  Offset(170),    BGMS, 8,  // Offset(170),   BIOS Guard Memory Size for Tool Interface
  Offset(171),    BGIA, 16, // Offset(171),   BIOS Guard IoTrap Address for Tool Interface
  //
  // Never Sleep Technology
  //
  Offset(173),    IRMC, 8,  // Offset(173),   Irmt Configuration
  //
  // Comms Hub
  //
  Offset(174),    CHEN, 8,  // Offset(174),   Comms Hub Enable/Disable
  Offset(175),    S0ID, 8,  // Offset(175),   Low Power S0 Idle Enable
  //
  // BIOS only version of Config TDP
  //
  Offset(176),    CTDB, 8,  // Offset(176),   enable/disable BIOS only version of Config TDP
  Offset(177),    DKSM, 8,  // Offset(177),   Dock SMI number
  //
  // LPC SIO configuration
  //
  Offset(500),              // Offset(178) : Offset(499), Reserved bytes
  ...
  Offset(540),    WGRC, 8,  // Offset(540),   Enable RTD3 Cold Support for Wigig  @deprecated since revision 6
  Offset(541),    WWRC, 8,  // Offset(541),   Enable RTD3 Cold Support for WWAN
  Offset(542),    SSH0, 16, // Offset(542),   SSCN-HIGH for I2C0
  Offset(544),    SSL0, 16, // Offset(544),   SSCN-LOW  for I2C0
  Offset(546),    SSD0, 16, // Offset(546),   SSCN-HOLD for I2C0
  Offset(548),    FMH0, 16, // Offset(548),   FMCN-HIGH for I2C0
  Offset(550),    FML0, 16, // Offset(550),   FMCN-LOW  for I2C0
  Offset(552),    FMD0, 16, // Offset(552),   FMCN-HOLD for I2C0
  Offset(554),    FPH0, 16, // Offset(554),   FPCN-HIGH for I2C0
  Offset(556),    FPL0, 16, // Offset(556),   FPCN-LOW  for I2C0
  Offset(558),    FPD0, 16, // Offset(558),   FPCN-HOLD for I2C0
  Offset(560),    HMH0, 16, // Offset(560),   HMCN-HIGH for I2C0
  Offset(562),    HML0, 16, // Offset(562),   HMCN-LOW  for I2C0
  Offset(564),    HMD0, 16, // Offset(564),   HMCN-HOLD for I2C0
  Offset(573),              // Offset(566) : Offset(572), Reserved bytes
  ...
  Offset(819),    SPST, 8,  // Offset(819),   SATA port state @deprecated since revision 3
  //
  // DPTF
  //
  ...
  Offset(881),    BATR, 8,  // Offset(881),   EnableBatteryParticipant
  Offset(888),              // Offset(882) : Offset(887), Reserved bytes
  Offset(888),    PSME, 8,  // Offset(888),   PowerSharingManagerEnable
  Offset(889),    PDT1, 8,  // Offset(889),   PsmSplcDomainType1
  Offset(890),    PLM1, 32, // Offset(890),   PsmSplcPowerLimit1
  Offset(894),    PTW1, 32, // Offset(894),   PsmSplcTimeWindow1
  Offset(898),    PDT2, 8,  // Offset(898),   PsmSplcDomainType2  @deprecated since revision 6
  Offset(899),    PLM2, 32, // Offset(899),   PsmSplcPowerLimit2  @deprecated since revision 6
  Offset(903),    PTW2, 32, // Offset(903),   PsmSplcTimeWindow2  @deprecated since revision 6
  Offset(907),    DDT1, 8,  // Offset(907),   PsmDplcDomainType1
  Offset(908),    DDP1, 8,  // Offset(908),   PsmDplcDomainPreference1
  Offset(909),    DLI1, 16, // Offset(909),   PsmDplcPowerLimitIndex1
  Offset(911),    DPL1, 16, // Offset(911),   PsmDplcDefaultPowerLimit1
  Offset(913),    DTW1, 32, // Offset(913),   PsmDplcDefaultTimeWindow1
  Offset(917),    DMI1, 16, // Offset(917),   PsmDplcMinimumPowerLimit1
  Offset(919),    DMA1, 16, // Offset(919),   PsmDplcMaximumPowerLimit1
  Offset(921),    DMT1, 16, // Offset(921),   PsmDplcMaximumTimeWindow1
  Offset(923),    DDT2, 8,  // Offset(923),   PsmDplcDomainType2         @deprecated since revision 6
  Offset(924),    DDP2, 8,  // Offset(924),   PsmDplcDomainPreference2   @deprecated since revision 6
  Offset(925),    DLI2, 16, // Offset(925),   PsmDplcPowerLimitIndex2    @deprecated since revision 6
  Offset(927),    DPL2, 16, // Offset(927),   PsmDplcDefaultPowerLimit2  @deprecated since revision 6
  Offset(929),    DTW2, 32, // Offset(929),   PsmDplcDefaultTimeWindow2  @deprecated since revision 6
  Offset(933),    DMI2, 16, // Offset(933),   PsmDplcMinimumPowerLimit2  @deprecated since revision 6
  Offset(935),    DMA2, 16, // Offset(935),   PsmDplcMaximumPowerLimit2  @deprecated since revision 6
  Offset(937),    DMT2, 16, // Offset(937),   PsmDplcMaximumTimeWindow2  @deprecated since revision 6
  Offset(939),    WIFE, 8,  // Offset(939),   WifiEnable
  Offset(940),    DOM1, 8,  // Offset(940),   WifiDomainType1
  Offset(941),    LIM1, 16, // Offset(941),   WifiPowerLimit1
  Offset(943),    TIM1, 32, // Offset(943),   WifiTimeWindow1
  Offset(947),    DOM2, 8,  // Offset(947),   WifiDomainType2            @deprecated since revision 6
  Offset(948),    LIM2, 16, // Offset(948),   WifiPowerLimit2            @deprecated since revision 6
  Offset(950),    TIM2, 32, // Offset(950),   WifiTimeWindow2            @deprecated since revision 6
  Offset(954),    DOM3, 8,  // Offset(954),   WifiDomainType3            @deprecated since revision 6
  Offset(955),    LIM3, 16, // Offset(955),   WifiPowerLimit3            @deprecated since revision 6
  Offset(957),    TIM3, 32, // Offset(957),   WifiTimeWindow3            @deprecated since revision 6
  Offset(961),    TRD0, 8,  // Offset(961),   TRxDelay0
  Offset(962),    TRL0, 8,  // Offset(962),   TRxCableLength0
  Offset(963),    TRD1, 8,  // Offset(963),   TRxDelay1
  Offset(964),    TRL1, 8,  // Offset(964),   TRxCableLength1
  Offset(965),    WDM1, 8,  // Offset(965),   WrddDomainType1
  Offset(966),    CID1, 16, // Offset(966),   WrddCountryIndentifier1
  Offset(968),    WDM2, 8,  // Offset(968),   WrddDomainType2            @deprecated since revision 6
  Offset(969),    CID2, 16, // Offset(969),   WrddCountryIndentifier2    @deprecated since revision 6
  Offset(1018),             // Offset(971) : Offset(1017), Reserved bytes
  ...
  Offset(1034),   WTVX, 8,  // Offset(1034),  WITT test devices' version
  Offset(1035),   WITX, 8,  // Offset(1035),  WITT test devices' connection point
  Offset(1036),   GPTD, 8,  // Offset(1036),  GPIO test devices
  Offset(1037),   GDBT, 16, // Offset(1037),  GPIO test devices' debounce value,
  Offset(1039),   UTKX, 8,  // Offset(1039),  UTK test devices' connection point
  Offset(1040),   SPTD, 8,  // Offset(1040),  SerialIo additional test devices
  Offset(1065),             // Offset(1041) : Offset(1064), Reserved bytes
  ...
  Offset(1765),   WRFE, 8,  // Offset(1765),  WigigRfe                  @deprecated since revision 6
  Offset(1766),   WRC1, 8,  // Offset(1766),  WiGigRfeCh1            @deprecated since revision 6
  Offset(1767),   WRC2, 8,  // Offset(1767),  WiGigRfeCh2            @deprecated since revision 6
  Offset(1768),   WRC3, 8,  // Offset(1768),  WiGigRfeCh3            @deprecated since revision 6
  Offset(1769),   WRC4, 8,  // Offset(1769),  WiGigRfeCh4            @deprecated since revision 6
  Offset(1770),   AWVI, 32, // Offset(1770),  AwvClassIndex        @deprecated since revision 6
  Offset(1774),   STDE, 8,  // Offset(1774),  EwrdWiFiDynamicSarEnable
  Offset(1775),   STRS, 8,  // Offset(1775),  EwrdWiFiDynamicSarRangeSets
  Offset(1776),   ST20, 8,  // Offset(1776),  EwrdWiFiSarTxPowerSet2Limit1
  Offset(1777),   ST21, 8,  // Offset(1777),  EwrdWiFiSarTxPowerSet2Limit2
  Offset(1778),   ST22, 8,  // Offset(1778),  EwrdWiFiSarTxPowerSet2Limit3
  Offset(1779),   ST23, 8,  // Offset(1779),  EwrdWiFiSarTxPowerSet2Limit4
  Offset(1780),   ST24, 8,  // Offset(1780),  EwrdWiFiSarTxPowerSet2Limit5
  Offset(1781),   ST25, 8,  // Offset(1781),  EwrdWiFiSarTxPowerSet2Limit6
  Offset(1782),   ST26, 8,  // Offset(1782),  EwrdWiFiSarTxPowerSet2Limit7
  Offset(1783),   ST27, 8,  // Offset(1783),  EwrdWiFiSarTxPowerSet2Limit8
  Offset(1784),   ST28, 8,  // Offset(1784),  EwrdWiFiSarTxPowerSet2Limit9
  Offset(1785),   ST29, 8,  // Offset(1785),  EwrdWiFiSarTxPowerSet2Limit10
  Offset(1786),   ST30, 8,  // Offset(1786),  EwrdWiFiSarTxPowerSet3Limit1
  Offset(1787),   ST31, 8,  // Offset(1787),  EwrdWiFiSarTxPowerSet3Limit2
  Offset(1788),   ST32, 8,  // Offset(1788),  EwrdWiFiSarTxPowerSet3Limit3
  Offset(1789),   ST33, 8,  // Offset(1789),  EwrdWiFiSarTxPowerSet3Limit4
  Offset(1790),   ST34, 8,  // Offset(1790),  EwrdWiFiSarTxPowerSet3Limit5
  Offset(1791),   ST35, 8,  // Offset(1791),  EwrdWiFiSarTxPowerSet3Limit6
  Offset(1792),   ST36, 8,  // Offset(1792),  EwrdWiFiSarTxPowerSet3Limit7
  Offset(1793),   ST37, 8,  // Offset(1793),  EwrdWiFiSarTxPowerSet3Limit8
  Offset(1794),   ST38, 8,  // Offset(1794),  EwrdWiFiSarTxPowerSet3Limit9
  Offset(1795),   ST39, 8,  // Offset(1795),  EwrdWiFiSarTxPowerSet3Limit10
  Offset(1796),   ST40, 8,  // Offset(1796),  EwrdWiFiSarTxPowerSet4Limit1
  Offset(1797),   ST41, 8,  // Offset(1797),  EwrdWiFiSarTxPowerSet4Limit2
  Offset(1798),   ST42, 8,  // Offset(1798),  EwrdWiFiSarTxPowerSet4Limit3
  Offset(1799),   ST43, 8,  // Offset(1799),  EwrdWiFiSarTxPowerSet4Limit4
  Offset(1800),   ST44, 8,  // Offset(1800),  EwrdWiFiSarTxPowerSet4Limit5
  Offset(1801),   ST45, 8,  // Offset(1801),  EwrdWiFiSarTxPowerSet4Limit6
  Offset(1802),   ST46, 8,  // Offset(1802),  EwrdWiFiSarTxPowerSet4Limit7
  Offset(1803),   ST47, 8,  // Offset(1803),  EwrdWiFiSarTxPowerSet4Limit8
  Offset(1804),   ST48, 8,  // Offset(1804),  EwrdWiFiSarTxPowerSet4Limit9
  Offset(1805),   ST49, 8,  // Offset(1805),  EwrdWiFiSarTxPowerSet4Limit10
  Offset(1806),   SD11, 8,  // Offset(1806),  WgdsWiFiSarDeltaGroup1PowerMax1
  Offset(1807),   SD12, 8,  // Offset(1807),  WgdsWiFiSarDeltaGroup1PowerChainA1
  Offset(1808),   SD13, 8,  // Offset(1808),  WgdsWiFiSarDeltaGroup1PowerChainB1
  Offset(1809),   SD14, 8,  // Offset(1809),  WgdsWiFiSarDeltaGroup1PowerMax2
  Offset(1810),   SD15, 8,  // Offset(1810),  WgdsWiFiSarDeltaGroup1PowerChainA2
  Offset(1811),   SD16, 8,  // Offset(1811),  WgdsWiFiSarDeltaGroup1PowerChainB2
  Offset(1812),   SD21, 8,  // Offset(1812),  WgdsWiFiSarDeltaGroup2PowerMax1
  Offset(1813),   SD22, 8,  // Offset(1813),  WgdsWiFiSarDeltaGroup2PowerChainA1
  Offset(1814),   SD23, 8,  // Offset(1814),  WgdsWiFiSarDeltaGroup2PowerChainB1
  Offset(1815),   SD24, 8,  // Offset(1815),  WgdsWiFiSarDeltaGroup2PowerMax2
  Offset(1816),   SD25, 8,  // Offset(1816),  WgdsWiFiSarDeltaGroup2PowerChainA2
  Offset(1817),   SD26, 8,  // Offset(1817),  WgdsWiFiSarDeltaGroup2PowerChainB2
  Offset(1818),   SD31, 8,  // Offset(1818),  WgdsWiFiSarDeltaGroup3PowerMax1
  Offset(1819),   SD32, 8,  // Offset(1819),  WgdsWiFiSarDeltaGroup3PowerChainA1
  Offset(1820),   SD33, 8,  // Offset(1820),  WgdsWiFiSarDeltaGroup3PowerChainB1
  Offset(1821),   SD34, 8,  // Offset(1821),  WgdsWiFiSarDeltaGroup3PowerMax2
  Offset(1822),   SD35, 8,  // Offset(1822),  WgdsWiFiSarDeltaGroup3PowerChainA2
  Offset(1823),   SD36, 8,  // Offset(1823),  WgdsWiFiSarDeltaGroup3PowerChainB2
  Offset(1842),             // Offset(1824) : Offset(1841), Reserved bytes
  ...
  Offset(1872),   ZPOD, 8,  // Offset(1872),  ZPODD @deprecated since revision 2
  ...
  Offset(1891),   ADAS, 8,  // Offset(1891),  Ac Dc Auto Switch Support
  Offset(1892),   PPBG, 32, // Offset(1892),  Pm Power Button Gpio Pin
  Offset(1896),   AEAB, 8,  // Offset(1896),  Acpi Enable All Button Support
  Offset(1897),   AHDB, 8,  // Offset(1897),  Acpi Hid Driver Button Support
  Offset(1898),   DPLL, 8,  // Offset(1898),  DPTF Display Depth Lower Limit in percent
  Offset(1899),   DPHL, 8,  // Offset(1899),  DPTF Display Depth Upper Limit in percent
  Offset(1900),   PWIG, 8,  // Offset(1900),  PEP F1 constraints for WiGig device            @deprecated since revision 6
  Offset(1901),   AUPL, 32, // Offset(1901),  Maximum aux power available for PCIe root ports
  Offset(1917),             // Offset(1905) : Offset(1916), Reserved bytes
  ...
  Offset(1926),   WGWS, 8,  // Offset(1926),  Wake on S3-S4 WiGig Docking Support                               @deprecated since revision 6
  //
  // UCMC setup option, GPIO Pad
  //
  Offset(1927),   UCSI, 8,  // Offset(1927),  Option to Enable/Disable UCSI/UCMC device
  Offset(1928),   UCG1, 32, // Offset(1928),  Gpio for UCMC Port 1 Interrupt
  Offset(1932),   UCG2, 32, // Offset(1932),  Gpio for UCMC Port 2 Interrupt
  Offset(1936),   UCG3, 32, // Offset(1936),  Gpio for UCMC Port 3 Interrupt
  Offset(1940),   UCG4, 32, // Offset(1940),  Gpio for UCMC Port 4 Interrupt
  Offset(1959),             // Offset(1944) : Offset(1958), Reserved bytes
  ...
  Offset(2017),   WLGP, 32, // Offset(2017),  WLAN PEWAKE Gpio pin
  Offset(2021),   WLRP, 8,  // Offset(2021),  WLAN Root Port Number
  }
