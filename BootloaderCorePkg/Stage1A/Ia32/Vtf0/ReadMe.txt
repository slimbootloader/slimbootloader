...
INF RuleOverride = RESET_VECTOR USE = IA32 BootloaderCorePkg/Stage1A/Ia32/Vtf0/Bin/ResetVector.inf
...
1. Change to VTF0 source dir: BootloaderCorePkg/Stage1A/Ia32/Vtf0
2. nasm and python should be in executable path
3. Run this command:
   python Build.py
4. Binaries output will be in BootloaderCorePkg/Stage1A/Ia32/Vtf0/Bin
